const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./localNotify-DvWQABvl.js","./index-DNzFMgCo.js","./vendor-C8IKlzsv.js","./vendor-react-DFxU1kFX.js","./vendor-antd-B1on7xmI.js","./vendor-antd-BdOndhxL.css"])))=>i.map(i=>d[i]);
...
${a.description?"备注："+a.description:""}`;if(e){const f=l.unit==="day"?"天":l.unit==="hour"?"小时":"分钟";try{const{fireReminderNow:g}=await Bn(async()=>{const{fireReminderNow:b}=await import("./localNotify-DvWQABvl.js");return{fireReminderNow:b}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);await g(`⏰ ${a.title}`,`${c.month()+1}月${c.date()}日 ${u}（提前${l.value}${f}提醒）`+(a.description?`
