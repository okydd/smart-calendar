...
${a.description?"备注："+a.description:""}`;if(e){const f=u.unit==="day"?"天":u.unit==="hour"?"小时":"分钟";try{const{fireReminderNow:g}=await Vn(async()=>{const{fireReminderNow:b}=await import("./localNotify-eXILiVpm.js");return{fireReminderNow:b}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);await g(`⏰ ${a.title}`,`${r.month()+1}月${r.date()}日 ${d}（提前${u.value}${f}提醒）`+(a.description?`
