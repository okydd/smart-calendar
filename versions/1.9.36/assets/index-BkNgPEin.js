const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./localNotify-BNvu0Q8O.js","./index-DNzFMgCo.js","./vendor-C8IKlzsv.js","./vendor-react-DFxU1kFX.js","./vendor-antd-D5F0PUiN.js","./vendor-antd-BdOndhxL.css"])))=>i.map(i=>d[i]);
var mo=Object.defineProperty;var vo=(t,e,o)=>e in t?mo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var Lt=(t,e,o)=>vo(t,typeof e!="symbol"?e+"":e,o);import{r as l,j as n,u as An,f as be,h as po,i as fo,k as ln,N as qt,R as je,l as go,H as Co}from"./vendor-react-DFxU1kFX.js";import{s as Cn,I as xn,A as fn,R as dt,a as It,b as _t,M as hn,c as et,d as Yn,e as Yt,f as bt,g as gn,h as Vt,i as xo,j as yo,k as ot,l as Bt,m as bo,n as jt,o as ke,p as Se,q as Ne,r as jo,t as ko,u as So,D as No,v as Fn,E as kt,w as we,x as wo,S as Eo,y as To,z as Ao,B as $o,C as at,F as Ee,G as Ro,H as Te,J as Po,K as Io,L as _o,N as Do,O as Ae,P as Mo,Q as Oo,T as $e,U as vt,V as Re,W as Uo,X as wn,Y as Lo,Z as qo,_ as Yo,$ as Vo,a0 as zt,a1 as Bo,a2 as zo,a3 as $n,a4 as Wo,a5 as Ko,a6 as Ho,a7 as Fo,a8 as Wt,a9 as Jo}from"./vendor-antd-D5F0PUiN.js";import{x as L,A as Xo,I as Go,y as Qo,J as Zo,K as na}from"./vendor-C8IKlzsv.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();const ta="modulepreload",ea=function(t,e){return new URL(t,e).href},Kt={},Bn=function(e,o,s){let a=Promise.resolve();if(o&&o.length>0){const c=document.getElementsByTagName("link"),d=document.querySelector("meta[property=csp-nonce]"),u=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));a=Promise.allSettled(o.map(h=>{if(h=ea(h,s),h in Kt)return;Kt[h]=!0;const i=h.endsWith(".css"),v=i?'[rel="stylesheet"]':"";if(!!s)for(let g=c.length-1;g>=0;g--){const b=c[g];if(b.href===h&&(!i||b.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${h}"]${v}`))return;const f=document.createElement("link");if(f.rel=i?"stylesheet":ta,i||(f.as="script"),f.crossOrigin="",f.href=h,u&&f.setAttribute("nonce",u),document.head.appendChild(f),i)return new Promise((g,b)=>{f.addEventListener("load",g),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(c){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=c,window.dispatchEvent(d),!d.defaultPrevented)throw c}return a.then(c=>{for(const d of c||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})};L.extend(Xo);L.extend(Go);L.extend(Qo);L.locale("zh-cn");const oa=["日","一","二","三","四","五","六"],pt=t=>t.format("YYYY-MM-DD"),an=t=>L(t,"YYYY-MM-DD",!0),aa=t=>t.isoWeekday(1),sa=t=>t.date(1),bn=t=>`星期${oa[t.day()]}`,ra=t=>`${t.format("MM")}月${t.format("DD")}日`,Kn=t=>t.allDay||!t.startTime?"全天":t.endTime?`${t.startTime} - ${t.endTime}`:t.startTime,yn=t=>{if(!t)return 0;const[e,o]=t.split(":").map(Number);return e*60+(o||0)},ca=()=>L().format("YYYY-MM-DD HH:mm:ss"),ia=t=>{try{const o=Zo.Solar.fromYmd(t.year(),t.month()+1,t.date()).getLunar();return`${o.getMonthInChinese()}月${o.getDayInChinese()}`}catch{return""}},St="calendarEvents",Jn={headerGradientStart:"#5e60ff",headerGradientEnd:"#3b7cff",textDark:"#1c1c1e"},Nt="007722",wt="#ff3b30",la=[{label:"14天",unit:"day",value:14},{label:"7天",unit:"day",value:7},{label:"3天",unit:"day",value:3},{label:"2天",unit:"day",value:2},{label:"1天",unit:"day",value:1},{label:"2小时",unit:"hour",value:2},{label:"1小时",unit:"hour",value:1},{label:"30分钟",unit:"minute",value:30},{label:"15分钟",unit:"minute",value:15}],jn="https://github.com/okydd/smart-calendar/releases/download/apk/smart-calendar.apk",Tn="https://okydd.github.io/smart-calendar/",_n="https://github.com/okydd/smart-calendar/releases/tag/apk",ua=90;function da(){try{const t=localStorage.getItem(St);if(!t)return null;const e=JSON.parse(t);if(!Array.isArray(e))return null;const o=Date.now(),s=ua*24*3600*1e3;return e.filter(a=>{if(!(a!=null&&a.deleted))return!0;const r=a.updatedAt?Date.parse(a.updatedAt):0;return o-r<s}).map(a=>({...a,updatedAt:a.updatedAt||new Date(0).toISOString()}))}catch{return null}}let Et=null;function Ht(t){Et=t}async function ha(t){try{return localStorage.setItem(St,JSON.stringify(t)),{ok:!0}}catch(e){const o=String((e==null?void 0:e.message)??""),s=o.includes("Quota")||o.includes("quota")||o.includes("exceeded")||o.includes("Exceeded");if(s&&Et)try{const r=await Et(t);return localStorage.setItem(St,JSON.stringify(r)),{ok:!0,rescued:!0}}catch(r){const c=String((r==null?void 0:r.message)??"");return console.error("配额救援失败",r),{ok:!1,error:"本机存储空间已满，自动把图片上传到云端失败："+c+"。请手动导出 JSON 备份后删除部分旧事件，或登录云同步后重试。"}}const a=s?"本机存储空间已满：事件中的图片过多，请导出 JSON 备份后删除部分旧事件，或开启云同步把图片上传到云端。":"保存日历事件失败："+o;return console.error("保存日历事件失败",e),{ok:!1,error:a}}}const ma=["sample-weekly-meeting","sample-fitness","sample-doctor","sample-review","sample-birthday","sample-reading"];function va(t){const e=(t.title||"").trim().replace(/\s+/g," "),o=t.allDay?"":(t.startTime||"").trim(),s=t.allDay?"":(t.endTime||"").trim();return[e,t.date,o,s,t.allDay?"1":"0"].join("")}function Ft(t){let e=0;return t.description&&t.description.trim()&&(e+=2),t.images&&t.images.length&&(e+=t.images.length*3),t.reminder&&t.reminder.length&&(e+=2),t.important&&(e+=1),t.done&&(e+=1),e}function Pe(t){const e=new Map;for(const s of t){if(s.deleted||!s.title||!s.date)continue;const a=va(s),r=e.get(a);r?r.push(s):e.set(a,[s])}const o=[];for(const[s,a]of e){if(a.length<2)continue;const r=[...a].sort((u,h)=>{const i=Ft(h)-Ft(u);if(i!==0)return i;const v=Date.parse(u.updatedAt||"")||0,m=Date.parse(h.updatedAt||"")||0;return m!==v?m-v:u.id.localeCompare(h.id)}),[c,...d]=r;o.push({key:s,title:c.title,date:c.date,keep:c,drop:d})}return o.sort((s,a)=>s.date.localeCompare(a.date)),o}function pa(t){return Pe(t).reduce((e,o)=>e+o.drop.length,0)}function Jt(t){const e=Pe(t);if(!e.length)return{events:t,removed:0};const o=new Set;for(const r of e)for(const c of r.drop)o.add(c.id);const s=new Date().toISOString();return{events:t.map(r=>o.has(r.id)?{...r,deleted:!0,updatedAt:s}:r),removed:o.size}}const Pn=()=>new Date().toISOString(),Xt="calendarDedupeV1",Gt="calendarCleanSampleV1";function fa(){return da()??[]}function Qt(t){return{...t,updatedAt:Pn()}}const Ie=l.createContext(null);function ga({children:t}){const[e,o]=l.useState(fa),[s,a]=l.useState("month"),[r,c]=l.useState(L()),[d,u]=l.useState(null),[h,i]=l.useState(""),[v,m]=l.useState(null),[f,g]=l.useState(0),b=l.useRef(e);b.current=e;const p=l.useRef(!1);l.useEffect(()=>{let I=!1;return(async()=>{const C=await ha(e);I||(C.ok?(C.rescued&&Cn.success("本机存储已满，已自动把图片上传到云端并释放空间",4),p.current=!1):p.current||(p.current=!0,Cn.error(C.error,6)))})(),()=>{I=!0}},[e]);const j=l.useCallback(I=>{o(C=>{const A=I(C);return b.current=A,A}),g(C=>C+1)},[]),E=l.useMemo(()=>e.filter(I=>!I.deleted&&I.kind!=="question"),[e]),P=l.useMemo(()=>{const I=h.trim().toLowerCase();return E.filter(C=>!(I&&!`${C.title} ${C.description||""}`.toLowerCase().includes(I)))},[E,h]),R=l.useMemo(()=>E.find(I=>I.id===d)??null,[E,d]),S=l.useCallback(I=>u(I),[]),T=l.useCallback(I=>{j(C=>{var A;return[...C,Qt({...I,id:((A=crypto.randomUUID)==null?void 0:A.call(crypto))??`${Date.now()}-${Math.random()}`})]})},[j]),M=l.useCallback((I,C)=>{j(A=>A.map(W=>W.id===I?{...W,...Qt(C)}:W))},[j]),q=l.useCallback(I=>{j(C=>C.map(A=>A.id===I?{...A,deleted:!0,updatedAt:Pn()}:A)),u(C=>C===I?null:C)},[j]),N=l.useCallback(I=>{j(C=>C.map(A=>A.id===I?{...A,done:!A.done,updatedAt:Pn()}:A))},[j]),y=l.useCallback(I=>{j(C=>{const A=new Set(I.map($=>$.id)),W=C.filter($=>!A.has($.id)&&!$.deleted).map($=>({...$,deleted:!0,updatedAt:Pn()}));return[...I.map($=>({...$,updatedAt:Pn()})),...W]}),u(null)},[j]),w=l.useMemo(()=>pa(e),[e]);l.useEffect(()=>{try{if(localStorage.getItem(Xt))return}catch{return}const I=setTimeout(()=>{try{localStorage.setItem(Xt,"1")}catch{}const{events:C,removed:A}=Jt(b.current);A>0&&(j(()=>C),Cn.success(`已自动清理 ${A} 条重复事件`,4))},8e3);return()=>clearTimeout(I)},[j]);const O=l.useCallback(()=>{const{events:I,removed:C}=Jt(b.current);return C>0&&j(()=>I),C},[j]);l.useEffect(()=>{try{if(localStorage.getItem(Gt))return}catch{return}const I=setTimeout(()=>{try{localStorage.setItem(Gt,"1")}catch{}const C=new Set(ma);let A=0;const W=b.current.map(_=>!_.deleted&&C.has(_.id)?(A++,{..._,deleted:!0,updatedAt:Pn()}):_);A>0&&(j(()=>W),Cn.success(`已移除 ${A} 条示例数据`,4))},9e3);return()=>clearTimeout(I)},[j]);const V=l.useCallback(I=>{o(()=>(b.current=I,I))},[]),F=l.useCallback(()=>b.current,[]),G={events:E,allEvents:e,filteredEvents:P,view:s,currentDate:r,selectedEventId:d,selectedEvent:R,search:h,focusQuestionId:v,setFocusQuestionId:m,revision:f,setView:a,setCurrentDate:c,selectEvent:S,setSearch:i,addEvent:T,updateEvent:M,deleteEvent:q,toggleDone:N,importEvents:y,duplicateCount:w,dedupeNow:O,applyMerged:V,snapshot:F};return n.jsx(Ie.Provider,{value:G,children:t})}function mn(){const t=l.useContext(Ie);if(!t)throw new Error("useCalendar 必须在 CalendarProvider 内使用");return t}const Dt="calendarSyncConfig";function _e(){const t="https://uppdqtukckhwkyuwpmuz.supabase.co".trim(),e="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVwcGRxdHVrY2tod2t5dXdwbXV6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODU4NDIyMTgsImV4cCI6MjEwMTQxODIxOH0.USdg-dX47lnQvD5JJ9dY_0sT1hj1rsvcGqU0K6hu1do".trim();return t&&e?{url:t,anonKey:e}:null}function Ca(){try{const t=localStorage.getItem(Dt);if(!t)return null;const e=JSON.parse(t);if(typeof(e==null?void 0:e.url)=="string"&&typeof(e==null?void 0:e.anonKey)=="string"&&e.url&&e.anonKey)return{url:e.url.trim(),anonKey:e.anonKey.trim()}}catch{}return null}function st(){return _e()??Ca()}function xa(){return _e()!==null}function ya(t){localStorage.setItem(Dt,JSON.stringify({url:t.url.trim().replace(/\/+$/,""),anonKey:t.anonKey.trim()}))}function ba(){localStorage.removeItem(Dt)}function ja(t,e){const o=t.trim(),s=e.trim();return o?/^https:\/\/[a-z0-9-]+\.supabase\.(co|in)$/i.test(o.replace(/\/+$/,""))?s?s.length<40?"anon key 看起来不完整，请复制完整的一长串字符":null:"请填写 anon public key":"Project URL 格式应为 https://xxxxx.supabase.co":"请填写 Project URL"}let In=null,rt="";function un(){const t=st();if(!t)return In=null,rt="",null;const e=`${t.url}|${t.anonKey}`;return In&&e===rt||(In=na(t.url,t.anonKey,{auth:{persistSession:!0,autoRefreshToken:!0,detectSessionInUrl:!1,storageKey:"calendarAuth"}}),rt=e),In}function Zt(){In=null,rt=""}const De=["purple","green","orange","red","blue","pink"];function ka(t){return{id:t.id,title:t.title??"",date:t.date??"",startTime:t.start_time??"",endTime:t.end_time??"",allDay:!!t.all_day,description:t.description??"",tag:De.includes(t.tag)?t.tag:"purple",kind:t.kind==="question"?"question":"event",done:!!t.done,deleted:!!t.deleted,important:!!t.important,images:Array.isArray(t.images)?t.images:[],reminder:Array.isArray(t.reminder)?t.reminder:void 0,updatedAt:t.updated_at}}function Sa(t,e){return{id:t.id,user_id:e,title:t.title??"",date:t.date??"",start_time:t.startTime??"",end_time:t.endTime??"",all_day:!!t.allDay,description:t.description??"",tag:De.includes(t.tag)?t.tag:"purple",kind:t.kind==="question"?"question":"event",done:!!t.done,deleted:!!t.deleted,important:!!t.important,images:Array.isArray(t.images)?t.images:[],reminder:Array.isArray(t.reminder)?t.reminder:[],updated_at:t.updatedAt||new Date(0).toISOString()}}const ne=t=>t&&Date.parse(t)||0;function Na(t,e){const o=new Map,s=[];let a=0;for(const c of t)o.set(c.id,c);for(const c of e){const d=o.get(c.id);if(!d){o.set(c.id,c),a++;continue}const u=ne(c.updatedAt),h=ne(d.updatedAt);let i,v,m;if(u>h)i=c,v=!0,m=!1;else if(h>u)i=d,v=!1,m=!0;else{const f=Array.isArray(c.images)&&c.images.length>0,g=Array.isArray(d.images)&&d.images.length>0;f&&!g?(i=c,v=!0,m=!1):g&&!f?(i=d,v=!1,m=!0):(i=c,v=!0,m=!1)}if(!Array.isArray(i.images)||i.images.length===0){const f=i===c?d:c;Array.isArray(f.images)&&f.images.length>0&&(i={...i,images:f.images},m=!0,v=!1)}if(!Array.isArray(i.reminder)||i.reminder.length===0){const f=i===c?d:c;Array.isArray(f.reminder)&&f.reminder.length>0&&(i={...i,reminder:f.reminder},m=!0,v=!1)}o.set(c.id,i),v&&a++,m&&s.push(i)}const r=new Set(e.map(c=>c.id));for(const c of t)r.has(c.id)||s.push(c);return{merged:Array.from(o.values()),toPush:s,pulledCount:a}}const Me="calendarStrongRemind",te={enabled:!0,sound:!0,vibrate:!0};function ct(){try{const t=localStorage.getItem(Me);if(t)return{...te,...JSON.parse(t)}}catch{}return te}function wa(t){try{localStorage.setItem(Me,JSON.stringify(t))}catch{}}const Oe=`

────────────
📱 智能日历安卓版（当前版本 APK）下载：
${jn}`,Ea=`<p class="foot"><a href="${jn}" style="color:#3b7cff;text-decoration:none;">📱 下载智能日历安卓版（当前版本 APK）</a></p>`,Ue="calendarNotify";function Ta(t){const e=new TextEncoder().encode(t);let o="";return e.forEach(s=>{o+=String.fromCharCode(s)}),btoa(o)}const ee={emailTarget:"",emailjsServiceId:"",emailjsTemplateId:"",emailjsPublicKey:"",wechatSendKey:"",dingtalkWebhook:"",dingtalkSecret:""};function cn(){try{const t=localStorage.getItem(Ue);if(t)return{...ee,...JSON.parse(t)}}catch{}return ee}function Le(t){localStorage.setItem(Ue,JSON.stringify(t))}function Dn(t=cn()){return!!(t.emailTarget&&t.emailjsServiceId&&t.emailjsTemplateId&&t.emailjsPublicKey)}function zn(t=cn()){return!!t.wechatSendKey}function Wn(t=cn()){return!!(t.dingtalkWebhook&&t.dingtalkWebhook.includes("access_token="))}function Aa(t,e){const o=t.filter(a=>!a.deleted).sort((a,r)=>a.date<r.date?-1:1).map(a=>{const r=an(a.date);return`${r.isValid()?`${r.month()+1}月${r.date()}日`:a.date} ${Kn(a)} ${a.title}`});return["【日历事件清单】",`选取时间范围：${e.rangeStart} 至 ${e.rangeEnd}`,`导出数据时间：${e.exportTime}`,`事件总数：${o.length} 条`].join(`
`)+`
`+(o.join(`
`)||"（无事件）")}function qe(t,e){const o=t.filter(a=>!a.deleted).sort((a,r)=>a.date<r.date?-1:1),s=o.map((a,r)=>{const c=an(a.date),d=c.isValid()?`${c.year()}年${c.month()+1}月${c.date()}日 ${bn(c)}`:a.date,u=[`${r+1}. ${a.title}${a.important?"【重要】":""}${a.done?"【已完成】":""}`,`   时间：${d} ｜ ${Kn(a)}`,a.description?`   备注：${a.description}`:""];if(a.images&&a.images.length){const h=a.images.filter(i=>/^https?:\/\//i.test(i));u.push(h.length?`   图片(${a.images.length} 张)：${h.join("  ")}`:`   图片：${a.images.length} 张（本地存储，详见网页端）`)}return u.filter(Boolean).join(`
`)}).join(`
`);return["【日历事件清单（完整版）】",`选取时间范围：${e.rangeStart} 至 ${e.rangeEnd}`,`导出数据时间：${e.exportTime}`,`事件总数：${o.length} 条`,"",s||"（无事件）"].join(`
`)+Oe}function dn(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ye(t){return t.filter(o=>!o.deleted).sort((o,s)=>o.date<s.date?-1:1).map(o=>{const s=an(o.date),a=s.isValid()?`${s.year()}年${s.month()+1}月${s.date()}日 ${bn(s)}`:o.date,r=Kn(o),c=(o.images||[]).filter(m=>/^https?:\/\//i.test(m)),d=(o.images||[]).length>c.length,u=c.length?`<div class="imgs">${c.map(m=>`<img src="${dn(m)}" alt="事件图片" />`).join("")}</div>`:"",h=d?'<div class="d" style="color:#999;">（含本地图片，未上传前不显示在邮件中）</div>':"",i=(o.important?'<span class="tag imp">重要</span>':"")+(o.done?'<span class="tag done">已完成</span>':""),v=o.description?dn(o.description).slice(0,500)+(o.description.length>500?"…":""):"";return`<div class="ev">
...
`)}function $a(t,e){const o=t.filter(a=>!a.deleted).sort((a,r)=>a.date<r.date?-1:1),s=Ye(t);return`<div style="font-family:-apple-system,'PingFang SC','Microsoft YaHei',sans-serif;background:#f3f4f8;color:#1c1c1e;padding:18px;margin:0;">
  ...
  ${Ea}
</div>`}function Ra(t,e){const o=t.filter(h=>!h.deleted).sort((h,i)=>h.date<i.date?-1:1),s=Ye(t),a=JSON.stringify(o,null,2),r=`data:application/json;base64,${Ta(a)}`;let c=!1,d;return qn(r)<=28*1024?(c=!0,d=`<a href="${r}" download="calendar-events-${dn(e.rangeStart)}_${dn(e.rangeEnd)}.json" class="btn" style="display:inline-block;background:linear-gradient(135deg,#3b7cff,#5e60ff);color:#fff;font-size:14px;font-weight:600;padding:10px 18px;border-radius:10px;text-decoration:none;">⬇️ 下载完整 JSON 数据</a>`):d='<div style="color:#999;font-size:12px;margin-top:10px;">本期数据较大，邮件内未生成下载链接，请在 APP 内「导出数据」获取 JSON。</div>',{html:`<div style="font-family:-apple-system,'PingFang SC','Microsoft YaHei',sans-serif;background:#f3f4f8;color:#1c1c1e;padding:18px;margin:0;">
  <div style="background:linear-gradient(135deg,#3b7cff,#5e60ff);color:#fff;border-radius:14px;padding:14px 18px;">
...
</div>`,withJson:c}}const ft=35*1024,Pa=3;function qn(t){try{return new Blob([t]).size}catch{return t.length}}function Xn(t,e,o){return JSON.stringify({service_id:e.emailjsServiceId,template_id:e.emailjsTemplateId,user_id:e.emailjsPublicKey,template_params:{...t,...o?{attachments:[{name:o.name,data:o.data,mimeType:o.mimeType}]}:{}}})}function Ia(t){return new Promise(e=>setTimeout(e,t))}function _a(t){if(!t)return!1;const e=String(t.message??"");return e.includes("CONNECTION_CLOSED")||e.includes("CONNECTION_REFUSED")||e.includes("CONNECTION_RESET")||e.includes("ETIMEDOUT")||e.includes("ECONNRESET")||e.includes("ECONNREFUSED")||e.includes("ETIMEDOUT")||e.includes("NetworkError")||e.includes("network")||e.includes("abort")||e.includes("timeout")||t.name==="TypeError"||t.name==="AbortError"}const Ve=15e3;function Da(t){return new Promise((e,o)=>{const s=new XMLHttpRequest;s.open("POST","https://api.emailjs.com/api/v1.0/email/send",!0),s.setRequestHeader("Content-Type","application/json"),s.timeout=Ve,s.onload=()=>{s.status>=200&&s.status<300?e(new Response(s.responseText,{status:s.status})):e(new Response(s.responseText,{status:s.status,statusText:s.statusText}))},s.onerror=()=>o(new Error("XHR network error")),s.ontimeout=()=>o(new Error("XHR timeout")),s.onabort=()=>o(new Error("XHR abort")),s.send(t)})}async function oe(t,e=Pa){let o=null;for(let s=0;s<e;s++){try{let a;try{const c=new AbortController,d=setTimeout(()=>c.abort(),Ve);a=await fetch("https://api.emailjs.com/api/v1.0/email/send",{method:"POST",headers:{"Content-Type":"application/json"},body:t,signal:c.signal,keepalive:!0}),clearTimeout(d)}catch{a=await Da(t)}if(a.ok)return a;const r=await a.text().catch(()=>"");if(r.toLowerCase().includes("size limit")||a.status===413)throw new Error("EmailJS size limit: "+r.slice(0,80));o=new Error(`HTTP ${a.status}: ${r.slice(0,80)}`);break}catch(a){if(o=a,!_a(a))break}s<e-1&&await Ia(800*(s+1))}throw o??new Error("邮件发送失败：网络异常，请检查网络后重试")}async function it(t,e,o){const s=cn();if(!Dn(s))return{ok:!1,msg:"未配置邮箱，仅本地操作"};const a=s.emailTarget.split(/[,\n]/).map(v=>v.trim()).filter(Boolean);if(a.length===0)return{ok:!1,msg:"未配置接收邮箱"};const r={to_email:a.join(","),subject:t,title:t,message:e};let c=e,d=o==null?void 0:o.html,u=!1;(()=>{if(d){const g=Xn({...r,message:c,html:d},s);if(qn(g)<=ft)return;d=void 0,u=!0}const v=Xn({...r,message:c},s);if(qn(v)<=ft)return;const m=`

[内容过长，已自动截断。完整数据请使用「导出JSON」备份。]`,f=ft-qn(Xn({...r,message:""},s))-qn(m)-200;f>0?c=c.slice(0,Math.floor(f/3))+m:c="【智能日历】事件过多，无法通过邮件发送。请使用「导出JSON」功能备份。",u=!0})();const i=v=>Xn({...r,message:c,...d?{html:d}:{}},s,v);try{if(o!=null&&o.attachment&&(await oe(i(o.attachment))).ok)return{ok:!0,msg:"已发送到邮箱（含附件）",downgraded:u};const v=await oe(i());return v.ok?{ok:!0,msg:u?"已发送到邮箱（内容较长，已自动精简排版）":"已发送到邮箱",downgraded:u}:{ok:!1,msg:"邮件发送失败："+(await v.text()).slice(0,80)}}catch(v){const m=((v==null?void 0:v.message)??"").slice(0,120);return m.toLowerCase().includes("size limit")?{ok:!1,msg:"邮件发送失败：内容超过 EmailJS 限制，请减少事件数量或用「导出JSON」备份"}:{ok:!1,msg:"邮件发送失败：网络异常，请检查网络后重试。若多次失败，可改用「复制事件」生成云端链接，或先「导出JSON」备份。("+m+")"}}}async function Be(t,e){const o=cn();if(!zn(o))return{ok:!1,msg:"未配置微信推送"};try{const s=`https://sctapi.ftqq.com/${o.wechatSendKey}.send?title=${encodeURIComponent(t)}&desp=${encodeURIComponent(e)}`,r=await(await fetch(s)).json().catch(()=>({}));return r&&r.code===0?{ok:!0,msg:"微信提醒已发送"}:{ok:!1,msg:"微信推送失败："+((r==null?void 0:r.message)??"未知错误")}}catch(s){return{ok:!1,msg:"微信推送失败："+((s==null?void 0:s.message)??"")}}}async function ze(t,e){var s;const o=cn();if(!Wn(o))return{ok:!1,msg:"未配置钉钉推送"};try{let a=o.dingtalkWebhook;const r=(s=o.dingtalkSecret)==null?void 0:s.trim();if(r){const u=Date.now(),h=`${u}
...
${e}`}})})).json().catch(()=>({}));return d&&d.errcode===0?{ok:!0,msg:"钉钉提醒已发送"}:{ok:!1,msg:"钉钉推送失败："+((d==null?void 0:d.errmsg)??"未知错误")}}catch(a){return{ok:!1,msg:"钉钉推送失败："+((a==null?void 0:a.message)??"")}}}const We="calendarReminderSent";function Ke(){try{return new Set(JSON.parse(localStorage.getItem(We)||"[]"))}catch{return new Set}}function Ma(t){const e=Ke();e.add(t),localStorage.setItem(We,JSON.stringify([...e].slice(-500)))}async function Oa(t){const e=ct().enabled;if(!e&&!zn()&&!Wn())return;const o=L(),s=Ke();for(const a of t){if(a.deleted||a.done||!a.reminder||a.reminder.length===0)continue;const r=an(a.date);if(!r.isValid())continue;let c=r.hour(9).minute(0);if(!a.allDay&&a.startTime){const[u,h]=a.startTime.split(":").map(Number);c=r.hour(u).minute(h)}const d=a.allDay?"全天":a.startTime;for(const u of a.reminder){const h=u.unit==="day"?c.subtract(u.value,"day"):u.unit==="hour"?c.subtract(u.value,"hour"):c.subtract(u.value,"minute");if(o.isBefore(h)||o.isAfter(c.add(2,"hour")))continue;const i=`${a.id}:${u.unit}:${u.value}`;if(s.has(i))continue;const v=`时间：${r.month()+1}月${r.date()}日 ${d}
${a.description?"备注："+a.description:""}`;if(e){const f=u.unit==="day"?"天":u.unit==="hour"?"小时":"分钟";try{const{fireReminderNow:g}=await Bn(async()=>{const{fireReminderNow:b}=await import("./localNotify-BNvu0Q8O.js");return{fireReminderNow:b}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);await g(`⏰ ${a.title}`,`${r.month()+1}月${r.date()}日 ${d}（提前${u.value}${f}提醒）`+(a.description?`
${a.description.slice(0,60)}`:""))}catch{}}const m=[];zn()&&m.push(Be(`事件提醒：${a.title}`,v)),Wn()&&m.push(ze(`事件提醒：${a.title}`,v)),await Promise.all(m),Ma(i)}}}const He="user_notify_settings";function Ua(t,e){return{user_id:e,email_target:t.emailTarget??"",emailjs_service_id:t.emailjsServiceId??"",emailjs_template_id:t.emailjsTemplateId??"",emailjs_public_key:t.emailjsPublicKey??"",wechat_send_key:t.wechatSendKey??"",dingtalk_webhook:t.dingtalkWebhook??"",dingtalk_secret:t.dingtalkSecret??""}}function La(t){return{emailTarget:t.email_target??"",emailjsServiceId:t.emailjs_service_id??"",emailjsTemplateId:t.emailjs_template_id??"",emailjsPublicKey:t.emailjs_public_key??"",wechatSendKey:t.wechat_send_key??"",dingtalkWebhook:t.dingtalk_webhook??"",dingtalkSecret:t.dingtalk_secret??""}}async function qa(t,e){try{const{data:o,error:s}=await t.from(He).select("*").eq("user_id",e).maybeSingle();return s?(console.warn("[notify-sync] 读取云端通知设置失败:",s.message),null):o?La(o):null}catch(o){return console.warn("[notify-sync] 读取云端通知设置异常:",o==null?void 0:o.message),null}}async function Ya(t,e,o){try{const s={...Ua(o,e),updated_at:new Date().toISOString()},{error:a}=await t.from(He).upsert(s,{onConflict:"user_id"});return a?(console.warn("[notify-sync] 推送云端通知设置失败:",a.message),!1):!0}catch(s){return console.warn("[notify-sync] 推送云端通知设置异常:",s==null?void 0:s.message),!1}}const ae="calendar_events",se="calendarLastSync",Va=3e5,Ba=1500,Fe=l.createContext(null);function Gn(t){const e=t.toLowerCase();return e.includes("invalid login credentials")?"邮箱或密码不正确":e.includes("user already registered")?"该邮箱已注册，请直接登录":e.includes("password should be at least")?"密码至少需要 6 位":e.includes("unable to validate email")||e.includes("invalid email")?"邮箱格式不正确":e.includes("email not confirmed")?"邮箱尚未验证，请先到邮箱点击验证链接":e.includes("signups not allowed")||e.includes("signup is disabled")||e.includes("not allowed to sign up")?"当前已关闭开放注册，如需账号请联系管理员开通":e.includes("does not exist")&&e.includes("relation")?"云端数据表未创建，请先在 Supabase 执行建表 SQL（见 SETUP.md）":e.includes("failed to fetch")||e.includes("networkerror")?"网络连接失败，请检查网络或 Project URL 是否正确":e.includes("row-level security")||e.includes("violates row-level")?"权限策略未生效，请确认已执行 SETUP.md 中的 RLS 策略语句":e.includes("over_email_send_rate_limit")||e.includes("rate limit")?"操作过于频繁，请稍后再试":t}function za({children:t}){const{snapshot:e,applyMerged:o,revision:s}=mn(),[a,r]=l.useState(()=>st()!==null),[c]=l.useState(()=>xa()),[d,u]=l.useState(()=>{var _;return((_=st())==null?void 0:_.url)??""}),[h,i]=l.useState(()=>st()?"signedOut":"disabled"),[v,m]=l.useState(null),[f,g]=l.useState(null),[b,p]=l.useState(()=>localStorage.getItem(se)),[j,E]=l.useState(null),[P,R]=l.useState(0),S=l.useRef(null),T=l.useRef(!1),M=l.useRef(!1),q=l.useCallback(async _=>{const $=un(),B=S.current;if(!(!$||!B)){if(T.current){M.current=!0;return}if(typeof navigator<"u"&&navigator.onLine===!1){_||i("offline");return}T.current=!0,_||(i("syncing"),E(null));try{const{data:J,error:K}=await $.from(ae).select("*").eq("user_id",B);if(K)throw new Error(K.message);const tn=(J??[]).map(ka),k=e(),{merged:D,toPush:z}=Na(k,tn);if(o(D),z.length){const U=z.map(H=>Sa(H,B));for(let H=0;H<U.length;H+=200){const{error:X}=await $.from(ae).upsert(U.slice(H,H+200),{onConflict:"user_id,id"});if(X)throw new Error(X.message)}}const x=new Date().toISOString();localStorage.setItem(se,x),p(x),_||i("idle")}catch(J){const K=Gn(J instanceof Error?J.message:String(J));E(K),_||i("error")}finally{T.current=!1,M.current&&(M.current=!1,q(_))}}},[e,o]),N=l.useCallback(()=>q(!1),[q]),y=l.useCallback(()=>q(!0),[q]),w=l.useCallback(async()=>{const _=un(),$=S.current;if(!_||!$)return;const B=await qa(_,$);B&&(Le(B),R(J=>J+1))},[]),O=l.useCallback(async _=>{const $=un(),B=S.current;return!$||!B?!1:Ya($,B,_)},[]);l.useEffect(()=>{if(!a)return;const _=un();if(!_)return;let $=!0;_.auth.getSession().then(({data:J})=>{if(!$)return;const K=J.session;K!=null&&K.user?(S.current=K.user.id,g(K.user.id),m(K.user.email??null),i("idle"),y(),w()):i("signedOut")});const{data:B}=_.auth.onAuthStateChange((J,K)=>{$&&(K!=null&&K.user?(S.current=K.user.id,g(K.user.id),m(K.user.email??null),i("idle"),w()):(S.current=null,g(null),m(null),i("signedOut")))});return()=>{$=!1,B.subscription.unsubscribe()}},[a]),l.useEffect(()=>{if(s===0||!S.current)return;const _=setTimeout(()=>void y(),Ba);return()=>clearTimeout(_)},[s,y]),l.useEffect(()=>{if(!a)return;const _=setInterval(()=>{S.current&&document.visibilityState==="visible"&&y()},Va),$=()=>{S.current&&document.visibilityState==="visible"&&y()},B=()=>{S.current&&y()};return document.addEventListener("visibilitychange",$),window.addEventListener("focus",$),window.addEventListener("online",B),()=>{clearInterval(_),document.removeEventListener("visibilitychange",$),window.removeEventListener("focus",$),window.removeEventListener("online",B)}},[a,N]);const V=l.useCallback((_,$)=>{const B=ja(_,$);return B||(ya({url:_,anonKey:$}),Zt(),u(_.trim().replace(/\/+$/,"")),r(!0),i("signedOut"),E(null),null)},[]),F=l.useCallback(()=>{ba(),Zt(),S.current=null,m(null),u(""),r(!1),i("disabled")},[]),G=l.useCallback(async(_,$)=>{const B=un();if(!B)return"请先填写 Supabase 连接参数";const{data:J,error:K}=await B.auth.signInWithPassword({email:_.trim(),password:$});return K?Gn(K.message):(J.user&&(S.current=J.user.id,g(J.user.id),m(J.user.email??null),i("idle"),N(),w()),null)},[N]),I=l.useCallback(async(_,$)=>{const B=un();if(!B)return"请先填写 Supabase 连接参数";const{data:J,error:K}=await B.auth.signUp({email:_.trim(),password:$});return K?Gn(K.message):J.session?(J.user&&(S.current=J.user.id,g(J.user.id),m(J.user.email??null),i("idle"),N(),w()),null):"__NEED_CONFIRM__"},[N]),C=l.useCallback(async()=>{const _=un();_&&await _.auth.signOut(),S.current=null,m(null),i("signedOut")},[]),A=l.useCallback(async _=>{const $=un();if(!$)return"请先填写 Supabase 连接参数";const{error:B}=await $.auth.resetPasswordForEmail(_.trim(),{redirectTo:window.location.origin+window.location.pathname});return B?Gn(B.message):null},[]),W=l.useMemo(()=>({status:h,email:v,lastSyncAt:b,error:j,configured:a,configLocked:c,configUrl:d,saveConfig:V,removeConfig:F,signIn:G,signUp:I,signOut:C,sendReset:A,syncNow:N,silentSync:y,userId:f,notifySettingsVersion:P,syncNotifySettings:O}),[h,v,b,j,a,c,d,V,F,G,I,C,A,N,y,f,P,O]);return n.jsx(Fe.Provider,{value:W,children:t})}function Sn(){const t=l.useContext(Fe);if(!t)throw new Error("useSync 必须在 SyncProvider 内使用");return t}const Je=l.createContext(null);function Wa({children:t}){const[e,o]=l.useState({open:!1,mode:"create",initial:null}),[s,a]=l.useState({open:!1,event:null}),[r,c]=l.useState(!1),[d,u]=l.useState(!1),{userId:h}=Sn(),i=l.useCallback(p=>{if(!h){Cn.warning("请先在「更多 → 云同步」登录后再新建事件");return}o({open:!0,mode:"create",initial:p??null})},[h]),v=l.useCallback(p=>{if(!h){Cn.warning("请先在「更多 → 云同步」登录后再编辑事件");return}o({open:!0,mode:"edit",initial:p})},[h]),m=l.useCallback(()=>{o(p=>({...p,open:!1}))},[]),f=l.useCallback(p=>{a({open:!0,event:p})},[]),g=l.useCallback(()=>{a(p=>({...p,open:!1}))},[]),b={eventModal:e,openCreate:i,openEdit:v,closeEventModal:m,eventView:s,openView:f,closeEventView:g,sidebarOpen:r,setSidebarOpen:c,detailOpen:d,setDetailOpen:u};return n.jsx(Je.Provider,{value:b,children:t})}function Hn(){const t=l.useContext(Je);if(!t)throw new Error("useUI 必须在 UIProvider 内使用");return t}const re="event-images",ce=3,Ka=800;function Ha(t){return typeof t=="string"&&t.startsWith("data:")}function Fa(t){return typeof t=="string"&&(t.startsWith("http://")||t.startsWith("https://"))}function Ja(t){return new Promise(e=>setTimeout(e,t))}function Xa(t){const e=String((t==null?void 0:t.message)??"");return e.includes("CONNECTION_CLOSED")||e.includes("CONNECTION_REFUSED")||e.includes("CONNECTION_RESET")||e.includes("ERR_HTTP2")||e.includes("HTTP2")||e.includes("ECONNRESET")||e.includes("ECONNREFUSED")||e.includes("ETIMEDOUT")||e.includes("NetworkError")||e.includes("network")||e.includes("timeout")||e.includes("abort")||(t==null?void 0:t.name)==="TypeError"||(t==null?void 0:t.name)==="AbortError"}function Ga(t){try{const[e,o]=t.split(","),s=(e.match(/data:(.*?);base64/)||[])[1]||"image/jpeg",a=atob(o),r=new Uint8Array(a.length);for(let c=0;c<a.length;c++)r[c]=a.charCodeAt(c);return new Blob([r],{type:s})}catch{return null}}async function Qa(t){if(!t||Fa(t)||!Ha(t))return t;const e=un();if(!e)return t;let o;try{const{data:u}=await e.auth.getUser();if(!u.user)return t;o=u.user.id}catch{return t}const s=Ga(t);if(!s)return t;const a=s.type==="image/png"?"png":"jpg",r=Math.random().toString(36).slice(2,8),c=`${o}/${Date.now()}-${r}.${a}`;let d=null;for(let u=0;u<ce;u++)try{const{data:h,error:i}=await e.storage.from(re).upload(c,s,{contentType:s.type,upsert:!1,cacheControl:"31536000"});if(i)throw i;if(!h)throw new Error("upload returned no data");const{data:v}=e.storage.from(re).getPublicUrl(h.path);return v.publicUrl||t}catch(h){if(d=h,!Xa(h))break;u<ce-1&&await Ja(Ka*(u+1))}return console.error("[imageHost] upload failed after retries, fallback to dataURL:",d),t}async function lt(t){const e=[];for(const o of t||[])e.push(await Qa(o));return e}function Tt({columns:t,selected:e,onChange:o,itemHeight:s=36}){const a=l.useRef([]),r=l.useRef(o);r.current=o;const c=l.useRef({});l.useEffect(()=>{t.forEach((u,h)=>{if(c.current[h])return;const i=a.current[h];if(!i)return;const v=u.values.findIndex(m=>m.value===e[h]);if(v>=0){const m=v*s;Math.abs(i.scrollTop-m)>1&&(i.scrollTop=m)}})},[e,t,s]);const d=u=>{var m;const h=a.current[u];if(!h)return;window.clearTimeout(c.current[u]),c.current[u]=window.setTimeout(()=>{delete c.current[u]},260);const i=Math.max(0,Math.min(t[u].values.length-1,Math.round(h.scrollTop/s))),v=(m=t[u].values[i])==null?void 0:m.value;if(v!==void 0&&v!==e[u]){const f=[...e];f[u]=v,r.current(f)}};return n.jsx("div",{className:"wheel-picker",children:t.map((u,h)=>n.jsxs("div",{className:"wheel-col",children:[n.jsxs("div",{className:"wheel-scroll",ref:i=>{a.current[h]=i},style:{height:s*5},onScroll:()=>d(h),children:[n.jsx("div",{style:{height:s*2}}),u.values.map((i,v)=>n.jsx("div",{className:`wheel-item${e[h]===i.value?" active":""}`,style:{height:s,lineHeight:`${s}px`},onClick:()=>{const m=a.current[h];m&&m.scrollTo({top:v*s,behavior:"smooth"});const f=[...e];f[h]=i.value,r.current(f)},children:i.label},v)),n.jsx("div",{style:{height:s*2}})]}),n.jsx("div",{className:"wheel-hl",style:{height:s,top:s*2}})]},h))})}const{TextArea:Za}=xn,Nn=10;function ns(t,e=1280,o=.72){return new Promise(s=>{const a=new FileReader;a.onerror=()=>s(""),a.onload=()=>{const r=new Image;r.onerror=()=>s(""),r.onload=()=>{let{width:c,height:d}=r;if(c>e||d>e){const v=Math.min(e/c,e/d);c=Math.round(c*v),d=Math.round(d*v)}const u=document.createElement("canvas");u.width=c,u.height=d;const h=u.getContext("2d");if(!h){s("");return}h.drawImage(r,0,0,c,d);const i=(t.type||"").toLowerCase()==="image/png";try{s(u.toDataURL(i?"image/png":"image/jpeg",o))}catch{s("")}},r.src=String(a.result)},a.readAsDataURL(t)})}const ts=Array.from({length:16},(t,e)=>2020+e),es=Array.from({length:24},(t,e)=>({label:`${e}时`,value:e})),os=Array.from({length:12},(t,e)=>{const o=e*5;return{label:`${String(o).padStart(2,"0")}分`,value:o}});function Xe(t,e){return new Date(t,e,0).getDate()}function as(t,e){const o=Xe(t,e);return[{values:ts.map(s=>({label:`${s}年`,value:s}))},{values:Array.from({length:12},(s,a)=>({label:`${a+1}月`,value:a+1}))},{values:Array.from({length:o},(s,a)=>({label:`${a+1}日`,value:a+1}))}]}const ss=()=>[{values:es},{values:os}];function rs(){const{eventModal:t,closeEventModal:e}=Hn(),{addEvent:o,updateEvent:s,deleteEvent:a}=mn(),{message:r}=fn.useApp(),[c,d]=l.useState([]),u=l.useRef(null),{open:h,mode:i,initial:v}=t,m=v??{},[f,g]=l.useState(""),[b,p]=l.useState(""),[j,E]=l.useState("normal"),[P,R]=l.useState(!1),[S,T]=l.useState([2026,8,5]),[M,q]=l.useState([9,0]),[N,y]=l.useState([]),[w,O]=l.useState(!1),[V,F]=l.useState(!1),[G,I]=l.useState(S),[C,A]=l.useState(M),[W,_]=l.useState(P);l.useEffect(()=>{if(!h)return;g(m.title??""),p(m.description??""),E(m.important?"important":"normal"),d(Array.isArray(m.images)?m.images.slice(0,Nn):[]);const x=m.date?L(m.date,"YYYY-MM-DD"):L();if(T([x.year(),x.month()+1,x.date()]),i==="create")R(!1),q([9,0]);else{const U=m.allDay??!m.startTime;if(R(U),!U&&m.startTime){const[H,X]=m.startTime.split(":").map(Number);q([H,Math.min(55,Math.max(0,Math.round(X/5)*5))])}else q([9,0])}y(m.reminder&&m.reminder.length?m.reminder.map(U=>({...U})):[])},[h,v]);const $=x=>{const U=Array.from(x.target.files??[]);if(x.target.value="",!U.length)return;const H=Nn-c.length;U.length>H&&r.warning(`最多添加 ${Nn} 张图片，已为您保留前 ${H} 张`);const X=U.slice(0,Math.max(0,H));X.length!==0&&Promise.all(X.map(Z=>ns(Z))).then(Z=>d(en=>[...en,...Z.filter(Boolean)].slice(0,Nn)))},B=x=>d(U=>U.filter((H,X)=>X!==x)),J=x=>{let[U,H,X]=x;const Z=Xe(U,H);X>Z&&(X=Z),I([U,H,X])},K=()=>{const x=L();I([x.year(),x.month()+1,x.date()])},tn=x=>N.some(U=>U.unit===x.unit&&U.value===x.value),k=x=>{tn(x)?y(N.filter(U=>!(U.unit===x.unit&&U.value===x.value))):y([...N,{unit:x.unit,value:x.value}])},D=async()=>{if(!f.trim()){r.warning("请输入事件标题");return}const[x,U,H]=S,X=L(`${x}-${String(U).padStart(2,"0")}-${String(H).padStart(2,"0")}`);let Z=c;try{Z=await lt(c)}catch{}const en={title:f.trim(),date:X.format("YYYY-MM-DD"),allDay:P,startTime:P?"":`${String(M[0]).padStart(2,"0")}:${String(M[1]).padStart(2,"0")}`,endTime:"",description:b.trim(),tag:m.tag??"purple",important:j==="important",images:Z,reminder:N};i==="edit"&&m.id?s(m.id,en):o(en),e()},z=()=>{i==="edit"&&m.id&&hn.confirm({title:"确认删除该事件？",content:`「${m.title??f}」删除后将从所有设备移除，确定删除吗？`,okText:"删除",okButtonProps:{danger:!0},cancelText:"取消",onOk:()=>{a(m.id),e()}})};return h?n.jsxs("div",{className:"ev-overlay",onClick:e,children:[n.jsxs("div",{className:"ev-modal",onClick:x=>x.stopPropagation(),children:[n.jsxs("div",{className:"ev-head",children:[n.jsx("span",{className:"ev-title",children:i==="edit"?"编辑事件":"新建事件"}),n.jsx("button",{className:"ev-close",onClick:e,"aria-label":"关闭",children:n.jsx(dt,{})})]}),n.jsxs("div",{className:"ev-body",children:[n.jsxs("div",{className:"ev-field",children:[n.jsx("label",{className:"ev-label",children:"事件标题"}),n.jsx(xn,{value:f,onChange:x=>g(x.target.value),placeholder:"例如：团队周会",maxLength:20})]}),n.jsxs("div",{className:"ev-field",children:[n.jsx("label",{className:"ev-label",children:"日期与时间"}),n.jsxs("div",{className:"ev-datetime-row",children:[n.jsxs("button",{type:"button",className:"ev-datetime-card",onClick:()=>{I(S),O(!0)},children:[n.jsx("span",{className:"ev-dt-label",children:"日期"}),n.jsx("span",{className:"ev-dt-value",children:`${S[0]}/${String(S[1]).padStart(2,"0")}/${String(S[2]).padStart(2,"0")}`})]}),n.jsxs("button",{type:"button",className:`ev-datetime-card${P?" muted":""}`,onClick:()=>{const x=Math.min(55,Math.max(0,Math.round(M[1]/5)*5));A([M[0],x]),_(P),F(!0)},children:[n.jsx("span",{className:"ev-dt-label",children:"时间"}),n.jsx("span",{className:"ev-dt-value",children:P?"不选":`${String(M[0]).padStart(2,"0")}:${String(M[1]).padStart(2,"0")}`})]})]})]}),n.jsxs("div",{className:"imp-block",children:[n.jsx("div",{className:"imp-label ev-section-title",children:"事件级别"}),n.jsxs("div",{className:"imp-btns",children:[n.jsx("button",{type:"button",className:`imp-btn${j==="normal"?" active":""}`,onClick:()=>E("normal"),children:"普通事件"}),n.jsx("button",{type:"button",className:`imp-btn danger${j==="important"?" active":""}`,onClick:()=>E("important"),style:j==="important"?{borderColor:wt,color:"#fff",background:wt}:void 0,children:"重要事件"})]})]}),n.jsxs("div",{className:"remind-block",children:[n.jsx("div",{className:"imp-label ev-section-title",children:"消息通知"}),n.jsx("div",{className:"remind-presets",children:la.map(x=>n.jsx("button",{type:"button",className:`tag-chip-select${tn(x)?" active":""}`,onClick:()=>k(x),children:x.label},`${x.unit}-${x.value}`))})]}),n.jsxs("div",{className:"ev-field",children:[n.jsx("label",{className:"ev-label ev-section-title",children:"描述"}),n.jsx(Za,{value:b,onChange:x=>p(x.target.value),autoSize:{minRows:1,maxRows:10},placeholder:"补充说明（可选，最多 200 字）",maxLength:200})]}),n.jsxs("div",{className:"img-upload-block",children:[n.jsxs("div",{className:"img-upload-head",children:[n.jsxs("span",{className:"ev-section-title",children:["图片（最多 ",Nn," 张）"]}),n.jsxs("span",{className:"img-count",children:[c.length,"/",Nn]})]}),n.jsxs("div",{className:"img-thumbs",children:[c.map((x,U)=>n.jsxs("div",{className:"img-thumb",children:[n.jsx("img",{src:x,alt:""}),n.jsx("button",{type:"button",className:"img-del",onClick:()=>B(U),"aria-label":"删除图片",children:"×"})]},U)),c.length<Nn&&n.jsx("button",{type:"button",className:"img-add",onClick:()=>{var x;return(x=u.current)==null?void 0:x.click()},"aria-label":"添加图片",children:n.jsx(It,{})})]}),n.jsx("input",{ref:u,type:"file",accept:"image/*",multiple:!0,hidden:!0,onChange:$})]})]}),n.jsxs("div",{className:"ev-foot",children:[i==="edit"&&n.jsxs("button",{className:"ev-del",onClick:z,children:[n.jsx(_t,{})," 删除"]}),n.jsx("button",{className:"ev-cancel",onClick:e,children:"取消"}),n.jsx("button",{className:"ev-save",onClick:D,children:"保存"})]})]}),w&&n.jsx("div",{className:"ev-picker-overlay",onClick:x=>{x.stopPropagation(),O(!1)},children:n.jsxs("div",{className:"ev-picker-modal",onClick:x=>x.stopPropagation(),children:[n.jsx("div",{className:"ev-picker-body",children:n.jsx(Tt,{columns:as(G[0],G[1]),selected:G,onChange:J})}),n.jsxs("div",{className:"ev-picker-foot three",children:[n.jsx("button",{type:"button",onClick:x=>{x.stopPropagation(),O(!1)},children:"取消"}),n.jsx("button",{type:"button",onClick:x=>{x.stopPropagation(),K()},children:"清除"}),n.jsx("button",{type:"button",className:"primary",onClick:x=>{x.stopPropagation(),T(G),O(!1)},children:"设置"})]})]})}),V&&n.jsx("div",{className:"ev-picker-overlay ev-time-overlay",onClick:x=>{x.stopPropagation(),F(!1)},children:n.jsxs("div",{className:"ev-time-sheet",onClick:x=>x.stopPropagation(),children:[n.jsxs("div",{className:"ev-time-head",children:[n.jsx("button",{type:"button",onClick:x=>{x.stopPropagation(),F(!1)},children:"取消"}),n.jsx("span",{className:"ev-time-title",children:"选择时间"}),n.jsx("button",{type:"button",className:"primary",onClick:x=>{x.stopPropagation(),q(C),R(W),F(!1)},children:"确定"})]}),n.jsxs("div",{className:"ev-time-tabs",children:[n.jsx("button",{type:"button",className:W?"active":"",onClick:x=>{x.stopPropagation(),_(!0)},children:"不选择时间"}),n.jsx("button",{type:"button",className:W?"":"active",onClick:x=>{x.stopPropagation(),_(!1)},children:"选择时间"})]}),n.jsx("div",{className:`ev-time-wheels${W?" disabled":""}`,children:n.jsx(Tt,{columns:ss(),selected:C,onChange:x=>{_(!1),A(x)}})})]})})]}):null}function cs({images:t,gridClassName:e="evv-imgs",thumbClassName:o="evv-img"}){const[s,a]=l.useState(!1),[r,c]=l.useState(0),[d,u]=l.useState(null),h=l.useRef(null),i=l.useRef(null),v=t.length,m=l.useCallback(p=>{c(j=>(j+p+v)%v)},[v]);l.useEffect(()=>{if(!s)return;const p=j=>{j.key==="ArrowLeft"?m(-1):j.key==="ArrowRight"?m(1):j.key==="Escape"&&a(!1)};return window.addEventListener("keydown",p),()=>window.removeEventListener("keydown",p)},[s,m]),l.useEffect(()=>{if(!s)return;const p=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=p}},[s]);const f=p=>{h.current=p.touches[0].clientX,i.current=p.touches[0].clientY,u(0)},g=p=>{if(h.current==null||i.current==null)return;const j=p.touches[0].clientX-h.current,E=p.touches[0].clientY-i.current;Math.abs(j)>Math.abs(E)&&u(j)},b=p=>{const j=h.current,E=i.current;if(h.current=null,i.current=null,u(null),j==null||E==null)return;const P=p.changedTouches[0].clientX-j,R=p.changedTouches[0].clientY-E;Math.abs(P)>50&&Math.abs(P)>Math.abs(R)&&m(P<0?1:-1)};return v===0?null:n.jsxs(n.Fragment,{children:[n.jsx("div",{className:e,children:t.map((p,j)=>n.jsx("img",{src:p,className:o,alt:`图片 ${j+1}`,loading:"lazy",onClick:()=>{c(j),a(!0)}},j))}),s&&n.jsxs("div",{className:"img-lightbox",onClick:()=>a(!1),children:[n.jsx("button",{className:"img-lb-close","aria-label":"关闭",onClick:p=>{p.stopPropagation(),a(!1)},children:n.jsx(dt,{})}),v>1&&n.jsx("button",{className:"img-lb-nav img-lb-prev","aria-label":"上一张",onClick:p=>{p.stopPropagation(),m(-1)},children:"‹"}),n.jsx("img",{className:"img-lb-img",src:t[r],alt:`图片 ${r+1}`,draggable:!1,onClick:p=>p.stopPropagation(),style:{transform:d?`translateX(${d}px)`:void 0,transition:d?"none":"transform 0.25s ease",touchAction:"pan-y"},onTouchStart:f,onTouchMove:g,onTouchEnd:b},r),v>1&&n.jsx("button",{className:"img-lb-nav img-lb-next","aria-label":"下一张",onClick:p=>{p.stopPropagation(),m(1)},children:"›"}),v>1&&n.jsxs("div",{className:"img-lb-count",onClick:p=>p.stopPropagation(),children:[r+1," / ",v]})]})]})}function is(){const{eventView:t,openEdit:e,openCreate:o,closeEventView:s}=Hn(),{deleteEvent:a,toggleDone:r,filteredEvents:c}=mn(),d=t.event;if(!t.open||!d)return null;const u=c.find(p=>p.id===d.id),h=u?u.done:d.done,i=an(d.date),v=i.isValid()?`${i.month()+1}月${i.date()}日 ${bn(i)}`:d.date,m=Kn(d),f=!!(d.description&&d.description.trim()),g=!!(d.images&&d.images.length>0),b=()=>{hn.confirm({title:"确认删除该事件？",content:`「${d.title}」删除后本地保留 90 天可恢复，确定删除吗？`,okText:"删除",okButtonProps:{danger:!0},cancelText:"取消",centered:!0,onOk:()=>{a(d.id),s()}})};return n.jsx("div",{className:"ev-overlay",onClick:s,children:n.jsxs("div",{className:"ev-modal ev-view",onClick:p=>p.stopPropagation(),children:[n.jsxs("div",{className:"ev-head",children:[n.jsx("span",{className:"ev-title",children:"事件详情"}),n.jsx("button",{className:"ev-close",onClick:s,"aria-label":"关闭",children:n.jsx(dt,{})})]}),n.jsxs("div",{className:"ev-body",children:[n.jsxs("div",{className:"evv-card evv-main",children:[n.jsxs("div",{className:"evv-title-row",children:[n.jsx("span",{className:`evv-title${h?" done":""}`,children:d.title}),d.important&&n.jsx("span",{className:"imp-flag",style:{background:"#ffe9e8",color:wt},children:"重"}),h&&n.jsx("span",{className:"evv-done-tag",children:"已完成"})]}),n.jsxs("div",{className:"evv-meta2",children:[n.jsxs("div",{className:"evv-meta-item",children:[n.jsx("span",{className:"evv-ico",children:"📅"}),n.jsx("span",{children:v})]}),n.jsxs("div",{className:"evv-meta-item",children:[n.jsx("span",{className:"evv-ico",children:"🕒"}),n.jsx("span",{children:m})]})]})]}),f&&n.jsxs("div",{className:"evv-card",children:[n.jsx("div",{className:"evv-card-label",children:"备注"}),n.jsx("div",{className:"evv-desc",children:d.description})]}),g&&n.jsxs("div",{className:"evv-card",children:[n.jsxs("div",{className:"evv-card-label",children:["图片（",d.images.length,"）"]}),n.jsx(cs,{images:d.images})]}),n.jsxs("div",{className:"evv-status-row",children:[n.jsx("span",{className:"evv-status-label",children:"完成状态"}),n.jsxs("div",{className:"evv-toggle",children:[n.jsx("button",{type:"button",className:`opt${h?"":" active"}`,onClick:()=>{h&&r(d.id)},children:"未完成"}),n.jsx("button",{type:"button",className:`opt done${h?" active":""}`,onClick:()=>{h||r(d.id)},children:"已完成"})]})]})]}),n.jsxs("div",{className:"ev-foot ev-foot-stack",children:[n.jsxs("div",{className:"ev-foot-row",children:[n.jsx("button",{className:"ev-btn-new",onClick:()=>{o({date:d.date}),s()},children:"新建"}),n.jsx("button",{className:"ev-btn-edit",onClick:()=>{e(d),s()},children:"编辑"})]}),n.jsxs("div",{className:"ev-foot-row",children:[n.jsx("button",{className:"ev-btn-danger",onClick:b,children:"删除"}),n.jsx("button",{className:"ev-btn-gray",onClick:s,children:"取消"})]})]})]})})}const ut="calendarFabPos",ie="calendarFabPosVer",le=3,ue=56;try{localStorage.getItem(ie)!==String(le)&&(localStorage.removeItem(ut),localStorage.setItem(ie,String(le)))}catch{}function ls(){try{const t=localStorage.getItem(ut);if(!t)return null;const e=JSON.parse(t);if(typeof(e==null?void 0:e.x)=="number"&&typeof(e==null?void 0:e.y)=="number")return e}catch{}return null}function de(t){const e=Math.max(8,window.innerWidth-ue-8),o=Math.max(8,window.innerHeight-ue-8);return{x:Math.min(Math.max(8,t.x),e),y:Math.min(Math.max(8,t.y),o)}}function Ge({onClick:t,color:e="primary"}){const[o,s]=l.useState(()=>ls()),[a,r]=l.useState(!1),c=l.useRef({moved:!1,dx:0,dy:0,id:-1});l.useEffect(()=>{const m=()=>s(f=>f&&de(f));return window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]);const d=m=>{const f=m.currentTarget.getBoundingClientRect();c.current={moved:!1,dx:m.clientX-f.left,dy:m.clientY-f.top,id:m.pointerId},m.currentTarget.setPointerCapture(m.pointerId)},u=m=>{if(c.current.id!==m.pointerId||!m.currentTarget.hasPointerCapture(m.pointerId))return;const f=de({x:m.clientX-c.current.dx,y:m.clientY-c.current.dy}),g=m.currentTarget.getBoundingClientRect();!c.current.moved&&Math.abs(f.x-g.left)<5&&Math.abs(f.y-g.top)<5||(c.current.moved=!0,r(!0),s(f))},h=m=>{if(c.current.id===m.pointerId){try{m.currentTarget.releasePointerCapture(m.pointerId)}catch{}if(c.current.id=-1,c.current.moved){r(!1),s(f=>(f&&localStorage.setItem(ut,JSON.stringify(f)),f));return}r(!1),t()}},i=()=>{localStorage.removeItem(ut),s(null)},v=o?{left:o.x,top:o.y,right:"auto",bottom:"auto"}:void 0;return n.jsx("button",{className:`fab${e==="green"?" green":""}${a?" dragging":""}`,style:v,onPointerDown:d,onPointerMove:u,onPointerUp:h,onDoubleClick:i,"aria-label":"新建日程（可拖动）",title:"点击新建 · 按住可拖动 · 双击复位",children:n.jsx(It,{})})}function he({e:t}){const e=!!(t.description&&t.description.trim()),o=!!(t.images&&t.images.length>0);return!e&&!o?null:n.jsxs("span",{className:"ev-flags-mini",children:[e&&n.jsx("span",{className:"ev-chip ev-chip-note",title:"有备注",children:"注"}),o&&n.jsx("span",{className:"ev-chip ev-chip-img",title:"有图片",children:"图"})]})}const me=["周一","周二","周三","周四","周五","周六","周日"],us=["一","二","三","四","五","六","日"];function ds(t){const e=new Map;for(const o of t){const s=e.get(o.date);s?s.push(o):e.set(o.date,[o])}for(const o of e.values())o.sort((s,a)=>s.allDay!==a.allDay?s.allDay?-1:1:yn(s.startTime)-yn(a.startTime));return e}function hs(t,e){const o=L().startOf("day"),s=t.startOf("day");if(s.isBefore(o,"day"))return"已过期";if(s.isAfter(o,"day"))return`剩${s.diff(o,"day")}天`;if(!e.allDay&&e.startTime){const a=L(),[r,c]=e.startTime.split(":").map(Number),d=L().hour(r).minute(c).startOf("minute");if(d.isAfter(a))return`剩${Math.max(1,Math.ceil(d.diff(a,"hour",!0)))}小时`}return""}function ms(t,e){return t.isSame(e,"day")?"今天":t.isSame(e.add(1,"day"),"day")?"明天":t.isSame(e.add(2,"day"),"day")?"后天":""}function vs({showFab:t=!0}){const{filteredEvents:e,currentDate:o,setCurrentDate:s}=mn(),{openCreate:a,openView:r}=Hn(),{userId:c,silentSync:d}=Sn(),[u,h]=l.useState(""),[i,v]=l.useState(null),[m,f]=l.useState(null),[g,b]=l.useState(!1),[p,j]=l.useState(!1),E=l.useRef(null);l.useEffect(()=>{c&&d()},[c,d]);const P=L(),R=l.useMemo(()=>{if(p){const D=o.startOf("month").subtract((o.date(1).day()+6)%7,"day");return Array.from({length:42},(z,x)=>D.add(x,"day"))}const k=o.startOf("isoWeek");return Array.from({length:14},(D,z)=>k.add(z,"day"))},[p,o]),S=l.useMemo(()=>ds(e),[e]),T=k=>{if(k.done)return!0;const D=L(k.date);return D.isValid()&&D.isBefore(P,"day")},M=k=>{h(k>0?"slide-left":"slide-right"),s(o.add(k,"month")),window.setTimeout(()=>h(""),260)},q=()=>{h(""),s(L())},N=k=>{const D=k.touches[0];E.current={x:D.clientX,y:D.clientY}},y=k=>{const D=E.current;if(!D)return;E.current=null;const z=k.changedTouches[0],x=z.clientX-D.x,U=z.clientY-D.y;Math.abs(x)>55&&Math.abs(x)>Math.abs(U)*1.6&&M(x<0?1:-1)},{dayActive:w,weekActive:O,monthActiveEvents:V,monthRangeLabel:F,weekRangeLabel:G}=l.useMemo(()=>{const k=P.isoWeekday(1),D=k,z=k.add(6,"day"),x=D.add(7,"day"),U=z.add(7,"day"),H=D.add(14,"day"),X=z.add(14,"day"),Z=D.add(21,"day"),en=z.add(21,"day"),Y=(Q,rn,ho)=>!Q.isBefore(rn,"day")&&!Q.isAfter(ho,"day"),sn=pt(o),vn=[],Mn=[],ht=[];for(const Q of e){const rn=L(Q.date);if(rn.isValid()){if(Q.date===sn){vn.push(Q);continue}if(Y(rn,D,z)||Y(rn,x,U)){Mn.push(Q);continue}if(Y(rn,H,X)||Y(rn,Z,en)){ht.push(Q);continue}}}const mt=(Q,rn)=>Q.date!==rn.date?Q.date<rn.date?-1:1:Q.allDay!==rn.allDay?Q.allDay?-1:1:yn(Q.startTime)-yn(rn.startTime);vn.sort(mt),Mn.sort(mt),ht.sort(mt);const ro=vn.filter(Q=>!T(Q)),co=Mn.filter(Q=>!T(Q)),io=ht.filter(Q=>!T(Q)),lo=`${H.month()+1}月${H.date()}日 - ${en.month()+1}月${en.date()}日`,uo=`${D.month()+1}月${D.date()}日 - ${U.month()+1}月${U.date()}日`;return{dayActive:ro,weekActive:co,monthActiveEvents:io,monthRangeLabel:lo,weekRangeLabel:uo}},[e,o]),I=l.useMemo(()=>{if(!i)return[];const k=i.format("YYYY-MM");return e.filter(D=>D.date.startsWith(k)&&!D.deleted).sort((D,z)=>D.date!==z.date?D.date<z.date?-1:1:D.allDay!==z.allDay?D.allDay?-1:1:yn(D.startTime)-yn(z.startTime))},[e,i]),C=l.useMemo(()=>I.filter(k=>!T(k)),[I]),A=l.useMemo(()=>(m?e.filter(D=>D.date.startsWith(m.format("YYYY-MM"))):e).filter(D=>T(D)).reverse(),[m,e]),{doneThisWeek:W,doneRest:_}=l.useMemo(()=>{const k=P.isoWeekday(1),D=k.add(6,"day"),z=x=>{const U=L(x.date);return U.isValid()&&!U.isBefore(k,"day")&&!U.isAfter(D,"day")};return{doneThisWeek:A.filter(z),doneRest:A.filter(x=>!z(x))}},[A]),$=pt(o),B=o.isSame(P,"day"),J=me[(o.day()+6)%7],K=`${o.month()+1}月${o.date()}日 ${J}`,tn=(k,D,z=!1)=>{const x=L(k.date),U=!!k.done,H=!k.done&&x.isValid()&&x.isBefore(P,"day"),X=k.allDay||!k.startTime?"全天":k.startTime,Z=D&&x.isValid()?`${x.month()+1}月${x.date()}日 ${me[(x.day()+6)%7]}`:"",en=`event-pill${z?" event-pill-day":""}${k.important?" important":""}${k.done?" done-pill":" not-done"}`,Y=`remind-title${U?" struck":""}`,sn=D&&!z&&!k.done?ms(x,P):"";return z?n.jsx("div",{className:en,onClick:()=>r(k),children:n.jsxs("div",{className:"remind-oneline",children:[x.isSame(P,"day")&&!k.done?n.jsxs("span",{className:"remind-rel-time",children:[n.jsx("span",{className:"remind-rel",children:"今天"}),n.jsx("span",{className:`day-time${k.allDay||!k.startTime?" all-day":""}`,children:X})]}):n.jsx("span",{className:`day-time${k.allDay||!k.startTime?" all-day":""}${U?" struck":""}`,children:X}),n.jsx("span",{className:Y,children:k.title}),k.important&&n.jsx("span",{className:"imp-flag",children:"重"}),n.jsx(he,{e:k})]})},k.id):n.jsx("div",{className:en,onClick:()=>r(k),children:n.jsxs("div",{className:"remind-main",children:[n.jsxs("div",{className:"remind-title-line",children:[n.jsx("span",{className:Y,children:k.title}),k.important&&n.jsx("span",{className:"imp-flag",children:"重"}),n.jsx(he,{e:k})]}),n.jsxs("div",{className:"remind-time-line",children:[D&&Z&&n.jsx("span",{className:`remind-date${U?" struck":""}${H?" expired":""}`,children:Z}),sn?n.jsxs("span",{className:"remind-rel-time",children:[n.jsx("span",{className:"remind-rel",children:sn}),n.jsx("span",{className:`remind-time${k.allDay||!k.startTime?" all-day":""}${U?" struck":""}${H?" expired":""}`,children:X})]}):n.jsx("span",{className:`remind-time${k.allDay||!k.startTime?" all-day":""}${U?" struck":""}${H?" expired":""}`,children:X}),n.jsx("span",{className:`remind-hint${U||H?" expired":""}`,children:hs(x,k)})]})]})},k.id)};return n.jsxs("div",{className:"page",children:[n.jsxs("div",{className:"cal-card",children:[n.jsxs("div",{className:"month-bar",children:[n.jsxs("div",{className:"month-title",children:[o.year(),"年",o.month()+1,"月"]}),n.jsxs("div",{className:"month-nav",children:[n.jsx("button",{className:"nav-btn",onClick:()=>M(-1),"aria-label":"上个月",children:n.jsx(et,{})}),n.jsx("button",{className:"nav-btn",onClick:()=>M(1),"aria-label":"下个月",children:n.jsx(Yn,{})}),n.jsx("button",{className:"today-btn",onClick:q,children:"今天"})]})]}),n.jsx("div",{className:"week-head",children:us.map((k,D)=>n.jsx("span",{className:D>=5?"we":"",children:k},k))}),n.jsx("div",{className:`month-grid ${u}`,onTouchStart:N,onTouchEnd:y,children:R.map(k=>{const D=pt(k),z=S.get(D)??[],x=k.month()!==o.month(),U=k.day()===0||k.day()===6,H=k.isSame(P,"day"),X=["mcell",x?"out":"",U?"weekend":"",H?"today":"",D===$?"selected":"",z.length>0&&!x&&!H&&D!==$?"has-event":""].filter(Boolean).join(" ");return n.jsx("div",{className:X,onClick:()=>s(k),children:n.jsx("span",{className:"dnum",children:k.date()})},D)})}),n.jsx("div",{className:"month-toggle",children:p?n.jsxs("button",{className:"month-toggle-btn",onClick:()=>j(!1),children:[n.jsx(Yt,{})," 收起"]}):n.jsxs("button",{className:"month-toggle-btn",onClick:()=>j(!0),children:[n.jsx(bt,{})," 展开整月"]})})]}),n.jsxs("section",{className:"remind-card",children:[n.jsxs("div",{className:"remind-header today",children:[n.jsx(gn,{className:"remind-ico"}),n.jsx("span",{className:"remind-label",children:"日提醒"}),n.jsx("span",{className:"remind-range",children:K}),n.jsx("span",{className:`today-tag${B?" active":""}`,onClick:q,"aria-label":"今日提醒数",children:w.length})]}),w.length===0?n.jsxs("div",{className:"empty-remind",onClick:()=>a({date:$}),children:[n.jsx(gn,{className:"empty-check"}),"暂无安排",n.jsx(It,{className:"empty-plus"})]}):n.jsx("div",{className:"remind-list",children:w.map(k=>tn(k,!1,!0))})]}),O.length>0&&n.jsxs("section",{className:"remind-card",children:[n.jsxs("div",{className:"remind-header week",children:[n.jsx(gn,{className:"remind-ico"}),n.jsx("span",{className:"remind-label",children:"周提醒"}),n.jsx("span",{className:"remind-range",children:G}),n.jsx("span",{className:"remind-count",children:O.length})]}),n.jsx("div",{className:"remind-list",children:O.map(k=>tn(k,!0))})]}),n.jsxs("section",{className:"remind-card",children:[n.jsxs("div",{className:"remind-header month",children:[n.jsx(gn,{className:"remind-ico"}),n.jsx("span",{className:"remind-label",children:"月提醒"}),i?n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"nav-btn month-nav-inline",onClick:()=>v(i.subtract(1,"month")),"aria-label":"上个月",children:n.jsx(et,{})}),n.jsxs("span",{className:"remind-range month-nav-inline-label",children:[i.year(),"年",i.month()+1,"月（",I.length,"）"]}),n.jsx("button",{className:"nav-btn month-nav-inline",onClick:()=>v(i.add(1,"month")),"aria-label":"下个月",children:n.jsx(Yn,{})}),n.jsx("button",{className:"remind-back",onClick:()=>v(null),"aria-label":"返回近4周",children:"返回近4周"})]}):n.jsxs(n.Fragment,{children:[n.jsx("span",{className:"remind-range",children:F}),n.jsxs("button",{className:"remind-back",onClick:()=>v(o.startOf("month")),"aria-label":"按月查看",children:[n.jsx(Vt,{})," 按月查看"]})]})]}),i?n.jsx(n.Fragment,{children:C.length===0?n.jsx("div",{className:"empty-remind",children:"本月暂无安排"}):n.jsx("div",{className:"remind-list",children:C.map(k=>tn(k,!0))})}):n.jsx(n.Fragment,{children:V.length===0?n.jsx("div",{className:"empty-remind",children:"近 4 周暂无更多安排"}):n.jsx("div",{className:"remind-list",children:V.map(k=>tn(k,!0))})})]}),n.jsxs("section",{className:"remind-card done-card",children:[n.jsxs("div",{className:"remind-header done",children:[n.jsx(gn,{className:"remind-ico"}),n.jsx("span",{className:"remind-label",children:"已完成"}),m?n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"nav-btn month-nav-inline",onClick:()=>f(m.subtract(1,"month")),"aria-label":"上个月",children:n.jsx(et,{})}),n.jsxs("span",{className:"remind-range month-nav-inline-label",children:[m.year(),"年",m.month()+1,"月（",A.length,"）"]}),n.jsx("button",{className:"nav-btn month-nav-inline",onClick:()=>f(m.add(1,"month")),"aria-label":"下个月",children:n.jsx(Yn,{})}),n.jsx("button",{className:"remind-back",onClick:()=>f(null),"aria-label":"返回全部",children:"返回全部"})]}):n.jsxs(n.Fragment,{children:[n.jsx("span",{className:"remind-range",children:g?"全部":"本周"}),n.jsx("span",{className:"remind-count",children:g?A.length:W.length}),n.jsxs("button",{className:"remind-back",onClick:()=>f(o.startOf("month")),"aria-label":"按月查看",children:[n.jsx(Vt,{})," 按月查看"]})]})]}),n.jsx("div",{className:"remind-list done-list",children:m?A.length===0?n.jsx("div",{className:"empty-remind",children:"暂无已完成或已过期的事件"}):A.map(k=>tn(k,!0)):n.jsxs(n.Fragment,{children:[W.length===0&&!g?n.jsx("div",{className:"empty-remind",children:"暂无已完成事件"}):W.map(k=>tn(k,!0)),g&&_.map(k=>tn(k,!0))]})}),!m&&_.length>0&&n.jsx("div",{className:"month-toggle",children:n.jsxs("button",{className:"month-toggle-btn",onClick:()=>b(k=>!k),children:[g?n.jsx(Yt,{}):n.jsx(bt,{}),g?"收起":`展开全部（${_.length}）`]})})]}),t&&n.jsx(Ge,{onClick:()=>a({date:$})})]})}function ve(t){const e=L(t);return e.isValid()?`${e.month()+1}月${e.date()}日`:t||"未设置"}function ps(){var V,F,G,I;const{allEvents:t,addEvent:e,updateEvent:o,deleteEvent:s,toggleDone:a,focusQuestionId:r,setFocusQuestionId:c}=mn(),d=l.useMemo(()=>t.filter(C=>C.kind==="question"&&!C.deleted),[t]),u=l.useMemo(()=>{const C=new Set;for(const A of d)A.date&&C.add(A.date);return[...C].sort((A,W)=>W.localeCompare(A))},[d]),h=L().format("YYYY-MM-DD"),[i,v]=l.useState(null),[m,f]=l.useState(null),[g,b]=l.useState(!1),[p,j]=l.useState(null),E=l.useRef(null),P=l.useRef({}),R=l.useMemo(()=>[...d].sort((C,A)=>(A.date||"").localeCompare(C.date||"")),[d]),S=l.useMemo(()=>{if(!i)return null;const C=R.findIndex(A=>A.date===i);return C>=0?R[C].id:null},[R,i]),T=d.find(C=>C.id===m)||null;l.useEffect(()=>{r&&(f(r),b(!1),c(null))},[r,c]),l.useEffect(()=>{b(!1)},[m]),l.useEffect(()=>{u.length&&!i&&v(u.includes(h)?h:u[0])},[u]);const M=C=>{v(C);const A=P.current[C];A&&A.scrollIntoView({behavior:"smooth",block:"start"})},q=()=>j({mode:"create",q:{date:L().format("YYYY-MM-DD"),title:"",description:"",done:!1}}),N=C=>j({mode:"edit",q:{...C}}),y=()=>{var W;if(!p)return;const C=p.q;if(!((W=C.title)!=null&&W.trim())){Cn.warning("请填写题目");return}const A={title:C.title.trim(),date:C.date||L().format("YYYY-MM-DD"),startTime:"",endTime:"",allDay:!0,description:C.description||"",tag:"blue",kind:"question",done:!!C.done};p.mode==="create"?e(A):C.id&&o(C.id,A),j(null)},w=C=>{hn.confirm({title:"删除该思考题？",content:C.title,okText:"删除",cancelText:"取消",okButtonProps:{danger:!0},onOk:()=>{s(C.id),m===C.id&&f(null)}})},O=C=>a(C.id);return n.jsxs("div",{className:"page questions-page",children:[n.jsx("div",{className:"q-dates",children:u.length===0?n.jsx("div",{className:"q-dates-empty",children:"暂无"}):u.map(C=>{const A=L(C),W=C===i,_=C===h;return n.jsxs("button",{className:`q-date-chip${W?" active":""}${_?" today":""}`,onClick:()=>M(C),children:[n.jsx("span",{className:"q-day",children:A.isValid()?A.date():"?"}),n.jsx("span",{className:"q-wk",children:A.isValid()?bn(A):""})]},C)})}),n.jsx("div",{className:"q-main",children:n.jsx("div",{className:"q-list",ref:E,children:R.length===0?n.jsxs("div",{className:"q-list-empty",children:[n.jsx(xo,{className:"q-empty-ico"}),n.jsx("p",{children:"暂无思考题，点击右下角「+」新建"})]}):R.map(C=>{const A=C.id===S;return n.jsxs("div",{ref:W=>{P.current[C.date]=W},className:`q-card${C.done?" done":""}${A?" hi":""}`,onClick:()=>f(C.id),children:[n.jsxs("div",{className:"q-card-top",children:[n.jsx("span",{className:"q-card-date",children:ve(C.date)}),C.done&&n.jsx("span",{className:"q-card-done-tag",children:"已完成"})]}),n.jsx("div",{className:"q-card-title",children:C.title})]},C.id)})})}),n.jsx(Ge,{color:"green",onClick:q}),n.jsx(hn,{open:!!T,title:null,onCancel:()=>f(null),footer:null,destroyOnClose:!0,centered:!0,className:"q-detail-modal",children:T&&n.jsxs("div",{className:"q-detail",children:[n.jsx("div",{className:"q-detail-title",children:T.title}),n.jsxs("div",{className:"q-detail-meta",children:[n.jsx(gn,{})," ",ve(T.date)]}),T.description&&n.jsxs("div",{className:"q-detail-note",children:[n.jsxs("button",{type:"button",className:"q-note-toggle",onClick:()=>b(C=>!C),children:[n.jsx("span",{className:"q-note-label",children:"备注"}),n.jsxs("span",{className:"q-note-caret",children:[g?"收起":"展开",n.jsx(bt,{className:`q-caret-ico${g?" up":""}`})]})]}),g&&n.jsx("div",{className:"q-detail-note-body",children:T.description})]}),n.jsxs("div",{className:"q-actions",children:[n.jsxs("div",{className:"q-row",children:[n.jsx("div",{className:"q-status-block",children:n.jsxs("div",{className:"evv-toggle",children:[n.jsx("button",{type:"button",className:`opt${T.done?"":" active"}`,onClick:()=>{T.done&&O(T)},children:"未完成"}),n.jsx("button",{type:"button",className:`opt done${T.done?" active":""}`,onClick:()=>{T.done||O(T)},children:"已完成"})]})}),n.jsxs("button",{className:"q-btn edit",onClick:()=>N(T),children:[n.jsx(yo,{})," 编辑"]})]}),n.jsxs("div",{className:"q-row",children:[n.jsxs("button",{className:"q-btn danger",onClick:()=>w(T),children:[n.jsx(_t,{})," 删除"]}),n.jsx("button",{className:"q-btn cancel",onClick:()=>f(null),children:"取消"})]})]})]})}),n.jsx(hn,{open:!!p,title:(p==null?void 0:p.mode)==="edit"?"修改思考题":"新建思考题",onCancel:()=>j(null),onOk:y,okText:"保存",cancelText:"取消",destroyOnClose:!0,children:p&&n.jsxs("div",{className:"q-form",children:[n.jsx("label",{children:"题目"}),n.jsx("input",{className:"q-input",value:((V=p.q)==null?void 0:V.title)||"",onChange:C=>j({...p,q:{...p.q,title:C.target.value}}),placeholder:"输入题目"}),n.jsx("label",{children:"议题日期"}),n.jsx("input",{type:"date",className:"q-input",value:((F=p.q)==null?void 0:F.date)||"",onChange:C=>j({...p,q:{...p.q,date:C.target.value}})}),n.jsx("label",{children:"思考内容"}),n.jsx("textarea",{className:"q-input q-textarea",value:((G=p.q)==null?void 0:G.description)||"",onChange:C=>j({...p,q:{...p.q,description:C.target.value}}),placeholder:"记录你的思考……"}),n.jsxs("label",{className:"q-check",children:[n.jsx("input",{type:"checkbox",checked:!!((I=p.q)!=null&&I.done),onChange:C=>j({...p,q:{...p.q,done:C.target.checked}})}),"思考完毕"]})]})})]})}const fs=[{id:"1621625955",question:"你有哪些提升自我的好习惯？",author:"黛西巫巫",voteUp:500923,excerpt:"1.保持早睡，至少能修复30%的颜值bug。 2.猛看片，不挑国家。不管是中国的，日本的还是美国的，各个国家的奥斯卡、纪录片、TED、科普片都可以去看。 补充自己的知识盲区，聊天时还能有更多话题。 3.不刷朋友圈、抖音。每天比同龄人，至少多出1小时时间，用来看书、护肤、健身。 4.吃饭时，不看任何电子屏幕（手机、电视、电脑）。很简单，追剧不差这点时间，反而一起吃饭的人很重要，多聊会天，说不定就发现了一个好项目。其次，…",content:`1.保持早睡，至少能修复30%的颜值bug。
2.猛看片，不挑国家。
...
create policy "delete own" on public.calendar_events
  for delete using (auth.uid() = user_id);`;function qs({open:t,onClose:e}){const{message:o,modal:s}=fn.useApp(),{status:a,email:r,lastSyncAt:c,error:d,configured:u,configLocked:h,configUrl:i,saveConfig:v,removeConfig:m,signIn:f,signUp:g,signOut:b,sendReset:p,syncNow:j}=Sn(),[E,P]=l.useState(i),[R,S]=l.useState(""),[T,M]=l.useState(()=>{try{return localStorage.getItem(xe)||""}catch{return""}}),[q,N]=l.useState(""),[y,w]=l.useState("signIn"),[O,V]=l.useState(!1),F=!!r,G=()=>{const $=v(E,R);if($){o.error($);return}o.success("连接参数已保存，接下来注册或登录账号"),S("")},I=async()=>{if(!T.trim()||!q){o.warning("请填写邮箱和密码");return}V(!0);const $=y==="signIn"?await f(T,q):await g(T,q);if(V(!1),$==="__NEED_CONFIRM__"){s.info({title:"请先验证邮箱",content:`注册成功。我们已向 ${T.trim()} 发送了一封验证邮件，请点击邮件中的链接完成验证，然后回来登录。`,okText:"知道了"}),w("signIn");return}if($){o.error($);return}o.success(y==="signIn"?"登录成功，正在同步…":"注册成功，正在同步…");try{localStorage.setItem(xe,T.trim())}catch{}N("")},C=async()=>{if(!T.trim()){o.warning("请先填写邮箱地址");return}const $=await p(T);$?o.error($):o.success("重置密码邮件已发送，请查收邮箱")},A=()=>{s.confirm({title:"退出登录？",content:"退出后本设备将停止同步，已同步到云端的数据不会丢失，本机数据也会保留。",okText:"退出登录",cancelText:"取消",onOk:async()=>{await b(),o.success("已退出登录")}})},W=()=>{s.confirm({title:"断开云同步配置？",content:"将清除本机保存的连接参数并退出登录，应用回到纯本地模式。云端数据不受影响。",okText:"断开",cancelText:"取消",okButtonProps:{danger:!0},onOk:async()=>{await b(),m(),o.success("已断开云同步")}})},_=()=>u?F?a==="syncing"?n.jsx($n,{icon:n.jsx(zt,{spin:!0}),color:"processing",children:"同步中"}):a==="error"?n.jsx($n,{color:"error",children:"同步失败"}):a==="offline"?n.jsx($n,{color:"default",children:"离线"}):n.jsx($n,{icon:n.jsx(Ee,{}),color:"success",children:"已同步"}):n.jsx($n,{color:"orange",children:"未登录"}):n.jsx($n,{color:"default",children:"未启用"});return n.jsxs(hn,{open:t,onCancel:e,footer:null,title:n.jsxs("span",{children:[n.jsx(ke,{style:{color:"#6d5dfc",marginRight:8}}),"云同步"]}),width:520,children:[n.jsxs("div",{style:{marginBottom:14},children:["当前状态：",_(),F&&n.jsx("span",{style:{marginLeft:8,color:"#666",fontSize:13},children:r})]}),d&&n.jsxs("div",{style:{background:"#fff2f0",border:"1px solid #ffccc7",borderRadius:8,padding:"8px 12px",marginBottom:14,fontSize:13,color:"#cf1322"},children:[n.jsx(Uo,{style:{marginRight:6}}),d]}),!u&&n.jsxs(n.Fragment,{children:[n.jsx("p",{style:{fontSize:13,color:"#666",lineHeight:1.8},children:"填写你自己的 Supabase 项目参数后，手机和电脑登录同一个账号即可自动同步。 数据存放在你自己的数据库里，我们不接触任何内容。"}),n.jsxs("div",{style:{marginBottom:10},children:[n.jsx("label",{style:{fontSize:12,color:"#888"},children:"Project URL"}),n.jsx(xn,{value:E,onChange:$=>P($.target.value),placeholder:"https://xxxxxxxx.supabase.co"})]}),n.jsxs("div",{style:{marginBottom:14},children:[n.jsx("label",{style:{fontSize:12,color:"#888"},children:"anon public key"}),n.jsx(xn.TextArea,{value:R,onChange:$=>S($.target.value),placeholder:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",autoSize:{minRows:2,maxRows:4}})]}),n.jsx(wn,{type:"primary",block:!0,icon:n.jsx(Lo,{}),onClick:G,children:"保存连接参数"}),n.jsx(qo,{ghost:!0,style:{marginTop:12},items:[{key:"how",label:n.jsx("span",{style:{fontSize:13},children:"参数在哪里找？（点击展开）"}),children:n.jsxs("div",{style:{fontSize:13,lineHeight:2,color:"#555"},children:[n.jsx("b",{children:"1."})," 打开 supabase.com 用邮箱免费注册并新建一个项目（Region 选 Singapore 较快）。",n.jsx("br",{}),n.jsx("b",{children:"2."})," 项目左下角 ",n.jsx("b",{children:"Settings → API"}),"，把 ",n.jsx("b",{children:"Project URL"})," 和"," ",n.jsx("b",{children:"anon public"})," 两个值复制过来。",n.jsx("br",{}),n.jsx("b",{children:"3."})," 左侧 ",n.jsx("b",{children:"SQL Editor → New query"}),"，粘贴下面这段建表语句并点 Run：",n.jsx(Yo.Paragraph,{copyable:{text:ye},style:{background:"#f6f7fb",border:"1px solid #e8e8f0",borderRadius:8,padding:10,fontSize:11,maxHeight:180,overflow:"auto",marginTop:8,whiteSpace:"pre-wrap",fontFamily:"Consolas, Monaco, monospace"},children:ye})]})}]})]}),u&&!F&&n.jsxs(n.Fragment,{children:[n.jsxs("div",{style:{marginBottom:10},children:[n.jsx("label",{style:{fontSize:12,color:"#888"},children:"邮箱"}),n.jsx(xn,{value:T,onChange:$=>M($.target.value),placeholder:"邮箱（已为你记住上次账号）",autoComplete:"username"})]}),n.jsxs("div",{style:{marginBottom:14},children:[n.jsx("label",{style:{fontSize:12,color:"#888"},children:"密码（至少 6 位）"}),n.jsx(xn.Password,{value:q,onChange:$=>N($.target.value),onPressEnter:I,placeholder:"请输入密码",autoComplete:y==="signIn"?"current-password":"new-password"})]}),n.jsx(wn,{type:"primary",block:!0,loading:O,icon:n.jsx(Vo,{}),onClick:I,children:y==="signIn"?"登录并开始同步":"注册新账号"}),n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginTop:10,fontSize:13},children:[n.jsx("a",{onClick:()=>w(y==="signIn"?"signUp":"signIn"),children:y==="signIn"?"还没有账号？去注册":"已有账号？去登录"}),n.jsx("a",{onClick:C,children:"忘记密码"})]}),!h&&n.jsx("div",{style:{marginTop:16,textAlign:"center"},children:n.jsx("a",{style:{fontSize:12,color:"#999"},onClick:W,children:"重新填写连接参数"})})]}),u&&F&&n.jsxs(n.Fragment,{children:[n.jsxs("div",{style:{background:"#f6f7fb",borderRadius:10,padding:"12px 14px",fontSize:13,lineHeight:2,color:"#555",marginBottom:14},children:[n.jsxs("div",{children:["账号：",n.jsx("b",{children:r})]}),n.jsxs("div",{children:["上次同步：",c?L(c).format("YYYY-MM-DD HH:mm:ss"):"尚未同步"]}),n.jsx("div",{style:{color:"#888",fontSize:12},children:"数据每分钟自动同步一次，修改后 1.5 秒内也会立即上传。"})]}),n.jsx(wn,{type:"primary",block:!0,icon:n.jsx(zt,{spin:a==="syncing"}),loading:a==="syncing",onClick:()=>void j(),style:{marginBottom:10},children:"立即同步"}),n.jsx(wn,{block:!0,icon:n.jsx(Bo,{}),onClick:A,children:"退出登录"}),!h&&n.jsx(wn,{block:!0,type:"text",danger:!0,icon:n.jsx(zo,{}),style:{marginTop:6},onClick:W,children:"断开云同步"})]})]})}const yt="shareUnlocked",tt="__all__";function Ys(){const{id:t}=be(),e=An(),[o,s]=l.useState(null),[a,r]=l.useState(!0),[c,d]=l.useState(""),u=Cn,[h,i]=l.useState(()=>{try{if(sessionStorage.getItem(yt)==="1")return!0}catch{}if(typeof location<"u"&&new URLSearchParams(location.search).get("pwd")===Nt){try{sessionStorage.setItem(yt,"1")}catch{}return!0}return!1}),[v,m]=l.useState(""),[f,g]=l.useState(""),b=()=>{if(v===Nt){try{sessionStorage.setItem(yt,"1")}catch{}i(!0)}else g("访问密码错误")};l.useEffect(()=>{let N=!0;return(async()=>{if(!t){N&&(d("链接缺少分享 ID"),r(!1));return}const y=await bs(t);if(N){if(!y){d("未找到该分享数据，可能链接已失效或尚未生成"),r(!1);return}s(y),r(!1)}})(),()=>{N=!1}},[t]);const p=l.useMemo(()=>((o==null?void 0:o.events)||[]).filter(N=>!N.deleted),[o]),j=l.useMemo(()=>{const N=new Map;for(const y of p){const w=N.get(y.date)||[];w.push(y),N.set(y.date,w)}return[...N.entries()].sort((y,w)=>y[0]<w[0]?-1:1).map(([y,w])=>({date:y,list:w}))},[p]),E=l.useMemo(()=>{const N=[];for(const y of j){const w=an(y.date);if(!w.isValid())continue;const O=`${w.year()}-${w.month()+1}`,V=`${w.year()}年${w.month()+1}月`;let F=N.find(G=>G.key===O);F||(F={key:O,label:V,dates:[]},N.push(F)),F.dates.push(y)}return N},[j]),[P,R]=l.useState(tt),S=l.useMemo(()=>{if(P===tt)return j;const N=j.find(y=>y.date===P);return N?[N]:[]},[P,j]);if(!h)return n.jsxs("div",{className:"share-page",children:[n.jsx("div",{className:"share-topbar",children:n.jsxs("button",{className:"share-back",onClick:()=>e("/calendar"),children:[n.jsx(ot,{})," 返回日历"]})}),n.jsxs("div",{className:"share-lock",children:[n.jsx("div",{className:"share-lock-icon",children:n.jsx(Re,{})}),n.jsx("div",{className:"share-lock-title",children:"该分享链接需要访问密码"}),n.jsx("div",{className:"share-lock-tip",children:"请输入邮件中提供的访问密码以查看内容"}),n.jsx(xn.Password,{className:"share-lock-input",placeholder:"访问密码",value:v,onChange:N=>{m(N.target.value),g("")},onPressEnter:b,status:f?"error":void 0,autoFocus:!0}),f&&n.jsx("div",{className:"share-lock-err",children:f}),n.jsx(wn,{type:"primary",block:!0,onClick:b,children:"查看内容"})]})]});const T=()=>{if(!o)return;const N=new Blob([JSON.stringify(o,null,2)],{type:"application/json"}),y=URL.createObjectURL(N),w=document.createElement("a");w.href=y,w.download=`Calendar_Share_${L().format("YYYYMMDD_HHmmss")}.json`,w.click(),URL.revokeObjectURL(y),u.success("已下载 JSON")},M=N=>{const y=an(N.date),w=y.isValid()?`${y.year()}年${y.month()+1}月${y.date()}日 ${bn(y)}`:N.date;return n.jsxs("div",{className:"share-card",children:[n.jsxs("div",{className:"share-card-title",children:[N.title,N.important&&n.jsx("span",{className:"share-tag imp",children:"重要"}),N.done&&n.jsx("span",{className:"share-tag done",children:"已完成"})]}),n.jsxs("div",{className:"share-card-meta",children:["📅 ",w," ｜ 🕒 ",Kn(N)]}),N.description&&n.jsx("div",{className:"share-card-desc",children:N.description}),N.images&&N.images.length>0&&n.jsx("div",{className:"share-card-imgs",children:N.images.map((O,V)=>n.jsx("img",{src:O,alt:"事件图片",loading:"lazy"},V))})]},N.id)},q=(N,y)=>{const w=an(N),O=w.isValid()?`${w.year()}年${w.month()+1}月${w.date()}日 ${bn(w)}`:N;return n.jsxs("div",{className:"share-day-head",children:[n.jsx("span",{className:"share-day-dot"}),n.jsx("span",{className:"share-day-label",children:O}),n.jsx("span",{className:"share-day-count",children:y})]})};return a?n.jsxs("div",{className:"share-loading",children:[n.jsx(at,{}),n.jsx("div",{className:"share-loading-text",children:"正在加载分享数据…"})]}):c?n.jsxs("div",{className:"share-page",children:[n.jsx("div",{className:"share-topbar",children:n.jsxs("button",{className:"share-back",onClick:()=>e("/calendar"),children:[n.jsx(ot,{})," 返回日历"]})}),n.jsx("div",{className:"share-error",children:n.jsx(kt,{description:c})})]}):n.jsxs("div",{className:"share-page",children:[n.jsxs("div",{className:"share-topbar",children:[n.jsxs("button",{className:"share-back",onClick:()=>e("/calendar"),children:[n.jsx(ot,{})," 返回日历"]}),n.jsx(wn,{type:"primary",size:"small",icon:n.jsx(we,{}),onClick:T,children:"下载JSON"})]}),n.jsxs("div",{className:"share-head",children:[n.jsxs("div",{className:"share-head-title",children:[n.jsx(gn,{})," 智能日历 · 数据分享"]}),n.jsxs("div",{className:"share-meta",children:[(o==null?void 0:o.rangeStart)&&(o==null?void 0:o.rangeEnd)&&n.jsxs("span",{children:["范围：",o.rangeStart," 至 ",o.rangeEnd]}),(o==null?void 0:o.exportTime)&&n.jsxs("span",{children:["导出：",o.exportTime]}),n.jsxs("span",{children:["共 ",p.length," 条事件"]})]})]}),n.jsxs("div",{className:"share-shell",children:[n.jsxs("aside",{className:"share-nav",children:[n.jsxs("button",{className:`share-nav-all${P===tt?" active":""}`,onClick:()=>R(tt),children:[n.jsx(Wo,{})," 全部日期"]}),E.map(N=>n.jsxs("div",{className:"share-nav-group",children:[n.jsx("div",{className:"share-nav-group-label",children:N.label}),N.dates.map(y=>{const w=an(y.date),O=w.isValid()?`${w.month()+1}月${w.date()}日 ${bn(w)}`:y.date;return n.jsxs("button",{className:`share-nav-item${P===y.date?" active":""}`,onClick:()=>R(y.date),children:[n.jsx("span",{className:"share-nav-date",children:O}),n.jsx("span",{className:"share-nav-count",children:y.list.length})]},y.date)})]},N.key))]}),n.jsx("main",{className:"share-body",children:S.length===0?n.jsx("div",{className:"share-empty-body",children:"（无事件）"}):S.map(N=>n.jsxs("section",{className:"share-day",children:[q(N.date,N.list.length),n.jsx("div",{className:"share-day-cards",children:N.list.map(y=>M(y))})]},N.date))})]}),n.jsx("div",{className:"share-foot",children:"本页面由「智能日历」生成 · 数据保存在日历的云端，链接可分享给任何人查看"})]})}const Ut=5,Pt="autoExportLastSent",Vs=4e3;function Bs(t,e,o){return t.filter(s=>!s.deleted&&s.date>=e&&s.date<=o)}function zs(t,e){try{const o=cn();if(!e||!Dn(o))return;const s=L();if(s.hour()<Ut)return;const a=s.format("YYYY-MM-DD");if(localStorage.getItem(Pt)===a)return;const r=s.subtract(1,"month").date(1).format("YYYY-MM-DD"),c=s.format("YYYY-MM-DD"),d=Bs(t,r,c),u=s.format("YYYY-MM-DD HH:mm"),{html:h}=Ra(d,{rangeStart:r,rangeEnd:c,exportTime:u}),i=qe(d,{rangeStart:r,rangeEnd:c,exportTime:u});it(`智能日历 · 每日数据推送（${a}）`,i,{html:h}).then(v=>{v.ok&&localStorage.setItem(Pt,a)}).catch(()=>{})}catch{}}function Ws(t){try{const e=cn(),o=L(),s=o.format("YYYY-MM-DD");return!!t&&Dn(e)&&o.hour()>=Ut&&localStorage.getItem(Pt)!==s}catch{return!1}}function Ks(){const t=L();let e=t.hour(Ut).minute(0).second(0).millisecond(0);return e.isAfter(t)||(e=e.add(1,"day")),Math.max(0,e.valueOf()-t.valueOf())}function Hs(t,e){let o=null,s=null;const a=()=>{Ws(e)&&zs(t(),e)};o=setTimeout(a,Vs);const r=()=>{s=setTimeout(()=>{a(),r()},Ks())};r();const c=()=>{document.visibilityState==="visible"&&a()},d=()=>a();return document.addEventListener("visibilitychange",c),window.addEventListener("focus",d),()=>{o&&clearTimeout(o),s&&clearTimeout(s),document.removeEventListener("visibilitychange",c),window.removeEventListener("focus",d)}}async function Fs(t){try{const{Capacitor:e,registerPlugin:o}=await Bn(async()=>{const{Capacitor:r,registerPlugin:c}=await import("./index-DNzFMgCo.js");return{Capacitor:r,registerPlugin:c}},[],import.meta.url);if(!e.isNativePlatform())return;const s=o("BadgePlugin"),a=Math.max(0,Math.floor(t||0));await s.setBadge({count:a})}catch{}}function Js(){const t=An(),e=po(),{events:o,search:s,setSearch:a,filteredEvents:r,updateEvent:c}=mn(),{openView:d}=Hn(),{userId:u}=Sn(),h=e.pathname==="/settings",i=e.pathname.startsWith("/settings/"),v=/^\/zhihu\/.+/.test(e.pathname),[m,f]=l.useState(!1),g=l.useRef(o);l.useEffect(()=>{g.current=o},[o]),l.useEffect(()=>Hs(()=>g.current,u),[u]),l.useEffect(()=>{if(!u)return;let R=!1;return(async()=>{const{getNotifyPermission:S,requestNotifyPermission:T,syncScheduledReminders:M}=await Bn(async()=>{const{getNotifyPermission:y,requestNotifyPermission:w,syncScheduledReminders:O}=await import("./localNotify-BNvu0Q8O.js");return{getNotifyPermission:y,requestNotifyPermission:w,syncScheduledReminders:O}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);if(!ct().enabled)return;if(await S()==="prompt")try{await T()}catch{}R||await M(g.current)})().catch(()=>{}),()=>{R=!0}},[u]),l.useEffect(()=>{if(!u)return;let R=!1,S=0;return(async()=>{const{syncScheduledReminders:T}=await Bn(async()=>{const{syncScheduledReminders:M}=await import("./localNotify-BNvu0Q8O.js");return{syncScheduledReminders:M}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);ct().enabled&&(S=window.setTimeout(()=>{R||T(g.current).catch(()=>{})},500))})().catch(()=>{}),()=>{R=!0,S&&window.clearTimeout(S)}},[o,u]),l.useEffect(()=>(Ht(async R=>{if(!u)throw new Error("未登录云同步账号，无法上传图片释放空间");const S=[];for(const T of R){const M=T.images||[];if(!M.some(y=>typeof y=="string"&&y.startsWith("data:"))){S.push(T);continue}const N=await lt(M);S.push({...T,images:N})}return S}),()=>{Ht(null)}),[u]);const b=l.useRef(!1);l.useEffect(()=>{if(!u||b.current)return;let R=!1;return(async()=>{const S=g.current.filter(M=>(M.images||[]).some(q=>typeof q=="string"&&q.startsWith("data:")));if(!S.length)return;b.current=!0;let T=!0;for(const M of S){if(R)break;try{const q=M.images||[],N=await lt(q);N.some((y,w)=>y!==q[w])&&c(M.id,{images:N})}catch{T=!1}}if(T)try{localStorage.setItem("calendarImgMigrated","1")}catch{}})(),()=>{R=!0}},[u,c]),l.useEffect(()=>{let R=!0;const S=async()=>{if(R)try{await Oa(g.current)}catch{}};S();const T=window.setInterval(S,6e4),M=()=>S(),q=()=>{document.visibilityState==="visible"&&S()};return document.addEventListener("visibilitychange",q),window.addEventListener("focus",M),()=>{R=!1,window.clearInterval(T),document.removeEventListener("visibilitychange",q),window.removeEventListener("focus",M)}},[]);const p=L(),j=l.useMemo(()=>ia(p),[p]),E=e.pathname.startsWith("/todos")?"todos":e.pathname.startsWith("/zhihu")?"zhihu":e.pathname.startsWith("/settings")?"settings":"calendar",P=l.useMemo(()=>o.filter(R=>{const S=L(R.date);return S.isValid()&&S.isSame(p,"day")&&!R.done}).length,[o,p]);return l.useEffect(()=>{const R=navigator;if(typeof R.setAppBadge=="function")try{P>0?R.setAppBadge(P).catch(()=>{}):R.clearAppBadge().catch(()=>{})}catch{}Fs(P)},[P]),n.jsxs("div",{className:"app-shell",children:[h?n.jsx("div",{className:"topbar-spacer"}):i||v?null:n.jsx("header",{className:"topbar",children:n.jsx("div",{className:"topbar-row",children:n.jsxs("div",{className:"topbar-title",children:[n.jsxs("div",{className:"topbar-date",children:[p.year(),"年",p.month()+1,"月",p.date(),"日"]}),n.jsxs("div",{className:"topbar-sub",children:[bn(p)," · 农历",j]})]})})}),n.jsx("div",{className:"app-content",children:n.jsx("div",{className:"app-content-inner",children:n.jsxs(fo,{children:[n.jsx(ln,{path:"/",element:n.jsx(qt,{to:"/calendar",replace:!0})}),n.jsx(ln,{path:"/calendar",element:n.jsx(vs,{})}),n.jsx(ln,{path:"/todos",element:n.jsx(ps,{})}),n.jsx(ln,{path:"/zhihu",element:n.jsx(fe,{})}),n.jsx(ln,{path:"/zhihu/:id",element:n.jsx(fe,{})}),n.jsx(ln,{path:"/settings",element:n.jsx(_s,{onOpenSync:()=>f(!0)})}),n.jsx(ln,{path:"/settings/reminder",element:n.jsx(Ds,{})}),n.jsx(ln,{path:"/settings/data",element:n.jsx(Ms,{})}),n.jsx(ln,{path:"/settings/versions",element:n.jsx(Ls,{})}),n.jsx(ln,{path:"/share/:id",element:n.jsx(Ys,{})}),n.jsx(ln,{path:"*",element:n.jsx(qt,{to:"/calendar",replace:!0})})]})})}),!v&&n.jsxs("nav",{className:"tabbar",children:[n.jsxs("button",{className:`tabbar-item${E==="calendar"?" active":""}`,onClick:()=>t("/calendar"),children:[n.jsx(gn,{className:"tab-ico"}),"日历",P>0&&n.jsx("span",{className:"tab-badge",children:P>99?"99+":P})]}),n.jsxs("button",{className:`tabbar-item${E==="todos"?" active":""}`,onClick:()=>t("/todos"),children:[n.jsx(Ko,{className:"tab-ico"}),"思考题"]}),n.jsxs("button",{className:`tabbar-item${E==="zhihu"?" active":""}`,onClick:()=>t("/zhihu"),children:[n.jsx(jt,{className:"tab-ico"}),"知乎"]}),n.jsxs("button",{className:`tabbar-item${E==="settings"?" active":""}`,onClick:()=>t("/settings"),children:[n.jsx(Ho,{className:"tab-ico"}),"设置"]})]}),n.jsx(rs,{}),n.jsx(is,{}),n.jsx(qs,{open:m,onClose:()=>f(!1)}),n.jsx(hn,{open:!!s,onCancel:()=>a(""),footer:null,title:`搜索「${s}」共 ${r.length} 条`,className:"search-modal",styles:{body:{maxHeight:"70vh",overflowY:"auto"}},children:n.jsx("div",{className:"search-result-list",children:r.length===0?n.jsx("div",{className:"search-empty",children:"未找到匹配的事件"}):r.map(R=>n.jsxs("div",{className:"search-result-item",onClick:()=>{d(R),a("")},children:[n.jsx("span",{className:`sr-title${R.done?" done":""}`,children:R.title}),n.jsxs("span",{className:"sr-date",children:[R.date,R.startTime?" "+R.startTime:""]})]},R.id))})})]})}function Xs(){return n.jsx(ga,{children:n.jsx(za,{children:n.jsx(Wa,{children:n.jsx(Js,{})})})})}const Gs="calendarTheme",oo=l.createContext({mode:"light",resolved:"light",setMode:()=>{}});function Qs({children:t}){const[e]=l.useState("light"),o="light";l.useLayoutEffect(()=>{document.documentElement.dataset.theme=o;try{localStorage.removeItem(Gs)}catch{}window.dispatchEvent(new CustomEvent("themechange",{detail:o}))},[o]);const s=a=>{};return n.jsx(oo.Provider,{value:{mode:e,resolved:o,setMode:s},children:t})}function Zs(){return l.useContext(oo).resolved}const ao='-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif';class nr extends je.Component{constructor(){super(...arguments);Lt(this,"state",{error:null})}static getDerivedStateFromError(o){return{error:o}}componentDidCatch(o,s){console.error("App crashed:",o,s)}render(){var o,s;return this.state.error?n.jsxs("div",{style:{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,fontFamily:ao,color:"#333",background:"#fff",textAlign:"center"},children:[n.jsx("div",{style:{fontSize:18,fontWeight:700,marginBottom:12},children:"页面加载出错"}),n.jsx("pre",{style:{maxWidth:"90vw",maxHeight:"40vh",overflow:"auto",whiteSpace:"pre-wrap",wordBreak:"break-all",fontSize:12,color:"#d4380d",background:"#fff1f0",border:"1px solid #ffccc7",borderRadius:8,padding:12,marginBottom:16},children:String(((o=this.state.error)==null?void 0:o.stack)||((s=this.state.error)==null?void 0:s.message)||this.state.error)}),n.jsx("button",{onClick:()=>location.reload(),style:{padding:"10px 24px",fontSize:15,color:"#fff",background:"#3b7cff",border:"none",borderRadius:10},children:"重试"})]}):this.props.children}}function tr({children:t}){const e=Zs();return n.jsx(Fo,{locale:Jo,theme:{algorithm:e==="dark"?Wt.darkAlgorithm:Wt.defaultAlgorithm,token:{colorPrimary:"#3b7cff",borderRadius:10,fontFamily:ao}},children:n.jsx(fn,{children:t})})}go.createRoot(document.getElementById("root")).render(n.jsx(je.StrictMode,{children:n.jsx(nr,{children:n.jsx(Qs,{children:n.jsx(tr,{children:n.jsx(Co,{children:n.jsx(Xs,{})})})})})}));try{typeof window<"u"&&window.__hideBootFallback&&window.__hideBootFallback(),window.__appReady=!0}catch{}const Vn={COUNT_KEY:"appReloadCount",LAST_KEY:"appReloadAt",MAX:2,MIN_INTERVAL_MS:6e4,get(t){try{return sessionStorage.getItem(t)}catch{return null}},set(t,e){try{sessionStorage.setItem(t,e)}catch{}},del(t){try{sessionStorage.removeItem(t)}catch{}},can(){if(Number(this.get(this.COUNT_KEY)||"0")>=this.MAX)return!1;const t=Number(this.get(this.LAST_KEY)||"0");return!(t&&Date.now()-t<this.MIN_INTERVAL_MS)},mark(){this.set(this.COUNT_KEY,String(Number(this.get(this.COUNT_KEY)||"0")+1)),this.set(this.LAST_KEY,String(Date.now()))},reset(){this.set(this.COUNT_KEY,"0"),this.set(this.LAST_KEY,"0")},TARGET_KEY:"appReloadTarget",resetFor(t){this.get(this.TARGET_KEY)!==t&&(this.set(this.TARGET_KEY,t),this.reset())}},so=function(){try{if(sessionStorage.getItem("__freshLoad"))return sessionStorage.removeItem("__freshLoad"),!0}catch{}return!1}();if("serviceWorker"in navigator&&!so){const t=!!navigator.serviceWorker.controller;window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js",{updateViaCache:"none"}).then(o=>{o.update().catch(()=>{}),o.addEventListener("updatefound",()=>{const s=o.installing;s&&(Vn.reset(),s.addEventListener("statechange",()=>{if(s.state==="activated"&&navigator.serviceWorker.controller&&t&&Vn.can()){Vn.mark();try{sessionStorage.setItem("__freshLoad","1")}catch{}const a=location.href.includes("?")?"&":"?";location.replace(location.href.split("#")[0]+a+"_nocache="+Date.now()+(location.hash||""))}}))})}).catch(()=>{})})}(function(){const e="./version.json",o="appVersion",s=Vn;if(so){fetch(e+"?_="+Date.now(),{cache:"no-store"}).then(a=>a.ok?a.json():null).then(a=>{if(a&&a.semver)try{localStorage.setItem(o,a.semver)}catch{}}).catch(()=>{});return}fetch(e+"?_="+Date.now(),{cache:"no-store"}).then(a=>a.ok?a.json():null).then(a=>{if(!a||!a.semver)return;let r=null;try{r=localStorage.getItem(o)}catch{return}const c=u=>{try{localStorage.setItem(o,u)}catch{}};if(!r||r===a.semver){c(a.semver);return}if(Vn.resetFor(a.semver),!s.can()){c(a.semver);return}s.mark();try{sessionStorage.setItem("__freshLoad","1")}catch{}const d=location.href.includes("?")?"&":"?";location.replace(location.href.split("#")[0]+d+"_nocache="+Date.now()+(location.hash||""))}).catch(()=>{})})();export{Bn as _,ct as g,an as p};
