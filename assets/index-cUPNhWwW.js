const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./localNotify-gzZivmJ5.js","./index-DNzFMgCo.js","./vendor-C8IKlzsv.js","./vendor-react-DFxU1kFX.js","./vendor-antd-D5F0PUiN.js","./vendor-antd-BdOndhxL.css"])))=>i.map(i=>d[i]);
...
${a.description?"备注："+a.description:""}`;if(e){const f=u.unit==="day"?"天":u.unit==="hour"?"小时":"分钟";try{const{fireReminderNow:g}=await Bn(async()=>{const{fireReminderNow:b}=await import("./localNotify-gzZivmJ5.js");return{fireReminderNow:b}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);await g(`⏰ ${a.title}`,`${r.month()+1}月${r.date()}日 ${d}（提前${u.value}${f}提醒）`+(a.description?`
